...
<cfif browserName IS NOT "spider">
	...
	request.errorDomain="#Request.SecureSelf#?fuseaction=home.admin&error=display&ID=";
	</cfscript>
	...
	<cffile
      ...
      <cfmail to="#ERROR.MailTo#" from="#ERROR.MailTo#" subject="#cgi.server_name# Error"
        ...
        <br/><br/>
         ...
         <a href="#Request.SecureSelf#?fuseaction=home.admin&amp;error=list">See the complete error list</a><br/><br/>
      </cfmail>
