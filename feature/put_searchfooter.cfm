...
<!-- start feature/put_searchfooter.cfm -->
<div id="putsearchfooter" class="feature">
...
<table width="98%" border="0" cellspacing="0" cellpadding="0" class="section_footer">
	<tr>
		<td><img src="#Request.ImagePath#icons/up.gif" border="0" valign="baseline" alt="" hspace="2" vspace="0" /><a href="#XHTMLFormat(Request.currentURL)###top" class="section_footer" #doMouseover('top of page')#>top</a> 
...
|<img src="#Request.ImagePath#icons/left.gif" border="0" valign="middle" alt="" hspace="2" vspace="0" /><a href="#XHTMLFormat(catlast)#" class="section_footer" #doMouseover('back')#>#listlast(request.qry_get_cat.parentnames,":")#</a>
<cfelseif request.appsettings.featureroot gt 0>|<img src="#Request.ImagePath#icons/left.gif" border="0" valign="middle" alt="" hspace="2" vspace="0" /><a href="#XHTMLFormat(cathome)#" class="section_footer">features home</a>
</cfif>
</cfif>
</td>
		<td align="right">
...
<tr><td colspan="2"><img src="#Request.ImagePath#spacer.gif" height="8" width="1" border="0" alt="" hspace="0" vspace="0" /></td></tr>
</table>
</cfoutput>

</div>
<!-- end feature/put_searchfooter.cfm -->