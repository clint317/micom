...
<cfset fieldlist="do,Feature_ID,UID,sortby,order,recent_days,format,editorial">
...
<!-- start feature/reviews/dsp_reviews_table.cfm -->
<div id="dspreviewstable" class="feature">
...
<!-- end feature/reviews/dsp_reviews_table.cfm -->