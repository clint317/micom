...
">
<!-- start feature/reviews/dsp_edit_form.cfm -->
<div id="dspeditform" class="feature">
<cfoutput>
...
>
    ...
    <tr align="left">
	  ...
	  <td></td>
      <td><input type="text" name="anon_email" size="38" value="#HTMLEditFormat(attributes.anon_email)#" class="formfield" maxlength="100"/><br/>
...
<!-- end feature/reviews/dsp_edit_form.cfm -->
<div id="dspeditform" class="feature">
