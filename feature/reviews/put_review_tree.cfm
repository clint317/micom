...
<!-- start feature/reviews/put_review_tree.cfm -->
<div id="putreviewtree" class="feature">
		...
		<cfif maketreesortlevel is 1>
  		<tr>
			...
			<cfif currentrow is finalrow>
				<img src="#Request.ImagePath#icons/treeLastItem.gif" alt="" align="left" width="20" height="30" />
			<cfelse>
				<img src="#Request.ImagePath#icons/treeitem.gif" alt="" align="left"  width="20" height="30" />
			</cfif>
   ...
   <tr>
		<td height="30">
			...
			<cfif Review_ID is attributes.CurrentReview>
				<img src="#Request.ImagePath#icons/treeSelectedItem.gif" alt="" align="left" width="20" height="30" />
			<cfelse>
				<img src="#Request.ImagePath#icons/spacer.gif" alt="" align="left" width="20" height="30" />
			</cfif>
			...
			<cfloop index="i" from="1" to="#maketreesortlevel#">
				...
				<cfif maketreesortlevel is i and thelevel is i>
					<img src="#Request.ImagePath#icons/treeitem.gif" align="left" alt="" width="20" height="30" />
				
				<cfelseif thelevel is i>
					<img src="#Request.ImagePath#icons/treeSkipItem.gif" align="left" alt="" width="20" height="30" />
				
				<cfelseif maketreesortlevel is i>
					<img src="#Request.ImagePath#icons/treeLastItem.gif" align="left" alt="" width="20" height="30" />
					
				<cfelse>
					<img src="#Request.ImagePath#icons/spacer.gif" align="left" alt="" width="20" height="30" />
				</cfif>
...
<!-- end feature/reviews/put_review_tree.cfm -->
