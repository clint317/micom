...
<cfset fieldlist="uid,name,search_string,feature_type,accesskey,display_status,highlight,order,cid">
...
<cfset session.formKeys.featureRelated = formkey>
...
<table width="90%" cellspacing="4" border="0" cellpadding="0" class="formtext" style="color:###Request.GetColors.InputTText#">	</cfoutput>	
	...
	<tr>
		...
		<td>#author#</td>
		<td>#copyright#</td>
		<td>[<a href="#self#?#addedpath#&submit_related=#feature_ID#&formkey=#Hash(formkey,"SHA-256")##Request.Token2#">remove</a>]
		[<a href="#self#?fuseaction=feature.admin&feature=edit&feature_ID=#feature_ID##Request.Token2#">edit</a>]
		[<a href="#Request.StoreSelf#?fuseaction=feature.display&feature_ID=#feature_ID##Request.Token2#" target="store">view</a>]
		</td>
	</tr>		
	</cfoutput>
</table>
...
<!---- Category Browse --------->		
	<tr>
		...
		<tr>
			<td colspan="8" style="BACKGROUND-COLOR: ###Request.GetColors.inputHBgcolor#;"><img src="#Request.ImagePath#spacer.gif" alt="" height="1" width="1" /></td>
		</tr>
