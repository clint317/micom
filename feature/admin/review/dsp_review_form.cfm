...
<cfset fieldlist="Review_ID,Anonymous,Anon_Name,Anon_Loc,Anon_Email,Feature_ID,Editorial,Title,Comment,Rating,Posted,Updated,Approved,NeedsCheck,children">	
	...
	<cfswitch expression="#attributes.review#">
		...
		<cfcase value="edit">
			...
			<cfloop list="#fieldlist#" index="counter">
				<cfset attributes[counter] = qry_get_review[counter][1]>
			</cfloop>
	...
	<cfquery name="GetUser" datasource="#Request.ds#" username="#Request.DSuser#" password="#Request.DSpass#" >
	...
	<cfif attributes.parent_ID IS NOT 0>	
		<cfquery name="Parent_Review"  datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#" maxrows="1">
...
<cfmodule template="../../../customtags/format_admin_form.cfm"
	...
	<cfif GetDetail.recordcount>
		...
		<cfif isdefined("Parent_review.recordcount")>
			...
			<blockquote>
				<strong>#HTMLEditFormat(Parent_review.title)#</strong><br/>
				#HTMLEditFormat(Parent_review.comment)#<br/>
				<strong>Posted by:</strong>
				 <cfif Parent_review.Anonymous is 1>anonymous<cfelseif len(Parent_review.anon_name)>#HTMLEditFormat(Parent_review.anon_name)#<cfelse>#HTMLEditFormat(Parent_review.username)#</cfif>
...
<!--- review ID --->
	 ...
	 <!--- User_ID --->
	 	<tr>
			...
			<td></td>
			<td><input type="text" name="UName" value="#HTMLEditFormat(GetUser.Username)#" size="20" maxlength="50" class="formfield"/>
			</td>
		</tr>
...
<!--- anonymous --->
	...
	<tr>
	  ...
	  <td></td>
      <td>
	 	 <input type="text" name="anon_name" value="#HTMLEditFormat(attributes.anon_name)#" maxlength="100"  class="formfield"/>
		</td>
    </tr>
    ...
    <tr>
	  ...
	  <td></td>
      <td><input type="text" name="anon_email" size="45" value="#HTMLEditFormat(attributes.anon_email)#" maxlength="100" class="formfield"/>
	  </td>
    </tr>
    ...
    <tr>
	  ...
	  <td></td>
      <td><input type="text" name="Anon_Loc" size="45" value="#HTMLEditFormat(attributes.Anon_Loc)#" maxlength="100" class="formfield"/><br/>
	...
	<tr>
      ...
      <td><input type="text" name="title" value="#HTMLEditFormat(attributes.title)#" size="60" maxlength="100" class="formfield"/></td>
    </tr>
      ...
      <td  colspan="3" align="center">	
		...
		<cfset config.FlashBrowser = "false">
			<cfmodule 
				...
				toolbarSet="Basic" 
				config="#config#"
				Value="#Application.objGlobal.doImgPaths(attributes.comment)#"
				/>
	 	</td>
    </tr>
