...
<!--- Displays the List Edit form for reviews. This page is used to make common changes to multiple reviews at one time. Called by feature.admin&review=listform --->

<cfparam name="attributes.displaycount" default="12">

<!--- Create the string with the filter parameters --->		
<cfset fieldlist = "review,uid,uname,search_string,feature_ID,rating,approved,needsCheck,order,sortby,editorial,recent_days">
...
<cfoutput>		
	...
	<form action="#self#?fuseaction=feature.admin&review=listform#request.token2#" method="post">
	...
	<tr>
		...
		<td><span class="formtextsmall"><br/></span>
		<a href="#self#?fuseaction=feature.admin&review=listform#Request.Token2#">ALL</a><br/>
		</td></tr>
		</form>		
...
<cfif qry_get_reviews.recordcount gt 0>					
	...
	<cfset reviewList = ListAppend(reviewList, Review_ID)>
		...
		<tr>
			<td valign="top"><a href="#self#?fuseaction=feature.admin&review=edit&Review_ID=#Review_ID##Request.Token2#">
			Edit #Review_ID#</a></td>
		
			<td  valign="top" colspan="3">
			<a href="#Request.StoreSelf#?fuseaction=feature.reviews&do=display&Review_ID=#Review_ID##request.token2#" target="store"><strong>#HTMLEditFormat(LEFT(title, 50))#</strong></a><br/>
				
			<strong>re:</strong> <a href="#Request.StoreSelf#?fuseaction=feature.display&Feature_ID=#Feature_ID##request.token2#" target="store">#HTMLEditFormat(LEFT(Feature_Name, 50))#</a><br/>

			<em>by <cfif Anonymous is 1>a member<cfelseif user_ID><a href="#Request.StoreSelf#?fuseaction=feature.reviews&do=list&uid=#user_ID##request.token2#" target="store"><cfif len(anon_name)>#HTMLEditFormat(anon_name)#<cfelse>#HTMLEditFormat(username)#</cfif></a><cfelse>#HTMLEditFormat(anon_name)#</cfif>
			<cfif len(Anon_Loc)>from #HTMLEditFormat(Anon_Loc)#</cfif> on #dateformat(Posted,"mmm d, yyyy")#</em>
			<br/>#HTMLEditFormat(comment)#
		...
		<td  valign="top" colspan="2">
			<cfif children gte 1>
				<input type="hidden" name="Approved#Review_ID#" value="1"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; approved
			<cfelse>
