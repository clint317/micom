	  ...
	  <table border="0" cellpadding="0" cellspacing="0" class="TopTierNavBkgrd" width="100%">
	    <tbody>  <!----- TITLE ROW ------>
	      <tr class="TopTierHeader">
	        <td class="TopTierHeader"><img src="#Request.ImagePath#spacer.gif" alt="" width="1" height="2"/>
	        </td>
	      </tr>  <!----- SPACING ROW  ------>
	      <tr class="TopTierNav">
	        <td>
	          ...
	          <table border="0" cellpadding="0" cellspacing="0">
	            <tbody>
	              <tr>
					...
					<img src="#Request.ImagePath#spacer.gif" alt="" height="1" width="1" />
	                </td>  
	                ...
	                <td class="TopTierNav">
					<a class="TopTierNav" href="#Request.StoreSelf#?fuseaction=feature.display&feature_id=#attributes.feature_id##Request.Token2#" target="store">View</a>
	                </td>
	                <td class="TopTierNav" nowrap="nowrap" width="5">  &nbsp;
	                </td>
	              </tr>
