...
<cfset fieldlist="feature_type,Name,Author,copyright,display,approved,start,expire,priority,accesskey,highlight,reviewable,display_title,Sm_Title,Sm_image,short_desc,lg_title,lg_image,long_desc,passparam,Color_iD,Created,metadescription,keywords,titletag">	
		...
		<cfswitch expression="#feature#">
			...
			<cfcase value="edit">
				...
				<cfloop list="#fieldlist#" index="counter">
					<cfset attributes[counter]  = qry_get_feature[counter][1]>
				</cfloop>
	...
	<cfif ispermitted>		
	 	<tr>
			...
			<td>
				...
				<option value="" #doSelected(feature,'add')#>select user...</option>
...
<!--- Listing Title --->
 ...
 <!--- display --->
			<tr>
				...
				<td></td>
			 	<td><input type="radio" name="Feat_Display" value="1" #doChecked(attributes.Display)# /> Yes  
				&nbsp;&nbsp;<input type="radio" name="Feat_Display" value="0" #doChecked(attributes.Display,0)# /> No
				</td>
			</tr>
...
<!--- Large Title --->
 ...
 <!--- Large Image --->
			<tr>
				...
				<td></td>
				<td><input type="text" name="Lg_Image" size="30" maxlength="100" class="formfield" value="#attributes.Lg_Image#"/> <a href="JavaScript: newWindow = openWin('#self#?fuseaction=home.admin&select=image&fieldname=Lg_Image&fieldvalue=#attributes.Lg_Image#&dirname=/features', 'images', 'width=850,height=700,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=0,resizable=1'); newWindow.focus()" class="formtextsmall">Image Manager</a> &nbsp;  <a href="JavaScript: newWindow = openWin('#self#?fuseaction=home.admin&select=image&type=PDF&fieldname=Lg_Image&fieldvalue=#attributes.Lg_Image#&dirname=/features', 'images', 'width=850,height=700,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=0,resizable=1'); newWindow.focus()" class="formtextsmall">PDF Manager</a><br/>
...
<!--- Custom palette --->
			<tr>
				...
				<td></td>
		 		<td>
				<select name="feat_color_id" size="1" class="formfield" >
