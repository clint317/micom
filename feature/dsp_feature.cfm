...
<!-- start feature/dsp_feature.cfm -->
<div id="dspfeature" class="feature">
...
<cfif ispermitted OR qry_get_feature.user_id is Session.User_ID>
	<cfoutput><br/>
<span class="menu_admin">[<a href="#XHTMLFormat('#Request.SecureSelf#?fuseaction=feature.admin&feature=edit&feature_id=#attributes.feature_id##Request.AddToken#')#"  #doAdmin()#>EDIT FEATURE #attributes.Feature_id#</a>]</span></cfoutput>
</cfif>
