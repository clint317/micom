...
<!---<cfscript>writedump(var=attributes,expand=false,label='attributes',abort=false);writedump(var=Session,expand=false,label='Session',abort=true);</cfscript>--->
				...
				<cfif NOT BitAnd(reg_val, this_permission)>
					...
					<cfswitch expression = "#this_permission#">
						...
						<cfcase value="1">
							...
							<cfoutput>
							<!-- access/secure.cfm -->
							<h3>The email address we have for you is either not valid or not accepting emails from our site.<br/><br/>
							Please update your email address below OR <a href="mailto:#request.appsettings.MerchantEmail#">email the editor</a> to have your current email address reinstated.</h3>	
							</cfoutput>		
							<cfmodule template="../#caller.thisself#"
						...
						<cfcase value="4">
							<cfoutput>							
							<!-- access/secure.cfm -->
							<h3>Your registration information is incomplete. Please fill out	the form below.</h3>
							</cfoutput>
							<cfmodule template="../#caller.thisself#"
						...
						<cfcase value="8">
							<cfoutput>
							<!-- access/secure.cfm -->
							<h3>Your account registration information is incomplete. Please fill out	the form below.</h3>
							</cfoutput>
							<cfset permitted = FALSE>
							<cfbreak>
						</cfcase>
						...
						<cfcase value="16">
							...
							<!-- access/secure.cfm -->
							<p></p><p></p>
							<h3>You must be at least 18 years of age to access this area.</h3>
							</cfoutput>
							<cfset permitted = FALSE>
							<cfbreak>	
						</cfcase>
						...
						<cfcase value="32">
							<cfoutput>
							<!-- access/secure.cfm -->
							<h3>You must have a valid credit card number on file to continue. Please update your credit card information below.</h3>
							</cfoutput>
							<cfmodule template="../#caller.thisself#"
