...
<cfswitch expression="#membership#">
	...
	<cfcase value="edit">	
		...
		<cfloop list="#fieldlist#" index="counter">
			<cfset attributes[counter] = qry_get_membership[counter][1]>
		</cfloop>
...
<cfquery name="Membership_prods" datasource="#Request.ds#" username="#Request.DSuser#" password="#Request.DSpass#" >
...
<cfquery name="qry_get_prior" datasource="#Request.ds#"	username="#Request.DSuser#"  password="#Request.DSpass#" >
