...
<cfquery name="calcShipping" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#" maxrows="1">
...
<cfif calcShipping.RecordCount>
	...
	<cfif arguments.ShipType IS "Items" AND arguments.CumulativeAmounts>
		<cfquery name="getCumAmounts" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
	...
	<cfquery name="GetCountryInfo" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#" maxrows="1">
