...
<!-- start shopping/giftregistry/dsp_giftregistry.cfm -->
<div id="dspgiftregistry" class="shopping">
...
<cfmodule  template="../../access/secure.cfm"
	...
	>		
	<cfoutput><p class="menu_admin">[<a href="#XHTMLFormat('#Request.SecureSelf#?fuseaction=shopping.admin&giftregistry=listitems&giftregistry_ID=#attributes.giftregistry_ID##Request.AddToken#')#" #doAdmin()#>Edit Gift Registry #giftregistry_ID#</a>]</p>
	</cfoutput>
</cfmodule>

</div>
<!-- end shopping/giftregistry/dsp_giftregistry.cfm -->
