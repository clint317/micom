...
<!-- start shopping/giftregistry/manager/dsp_notify.cfm -->
<div id="dspnotify" class="shopping">

<cfparam name="attributes.emailer_message" default="Gift Registry Link: #Request.StoreSelf#?fuseaction=shopping.giftregistry&ID=#attributes.giftregistry_id#">
...
<!-- end shopping/giftregistry/manager/dsp_notify.cfm -->
