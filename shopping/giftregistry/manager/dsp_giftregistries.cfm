...
<!-- start shopping/giftregistry/manager/dsp_giftregistries.cfm -->
...
<cfmodule template="../../../customtags/pagethru.cfm" 
	...
	<table cellspacing="2" cellpadding="2" border="0" width="100%" class="formtext">
		...
		<tr>
			...
			<td><a href="javascript:newWindow=openWin('#XHTMLFormat('#action#&manage=print&giftregistry_id=#giftregistry_ID#')#','Registry','width=700,height=800,toolbar=0,location=0,directories=0,status=0,menuBar=1,scrollBars=1,resizable=1'); newWindow.focus();">Print Registry</a></td>
		</tr>		
<tr>
			<td>&nbsp;</td>
...
<!-- end shopping/giftregistry/manager/dsp_giftregistries.cfm -->
