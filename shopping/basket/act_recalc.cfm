...
<cfloop index="Num" from="#qry_Get_Basket.RecordCount#" to="1" step="-1">
	...
	<cfif DeleteItem>
		...
		<cfquery name="DeleteItem" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
...
<cfif qry_Get_Basket.RecordCount>
	<cfquery name="get_qty_discounts" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
	...
	<cfquery name="get_grp_prices" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
...
<cfloop query="qry_Get_Basket">
	...
	<cfquery name="UpdBasket" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
