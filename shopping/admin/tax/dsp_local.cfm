...
<cfmodule template="../../../customtags/putline.cfm" linetype="thin" linecolor="#Request.GetColors.InputHBgcolor#" width="98%"/>
	...
	<cfset session.formKeys.LocalTaxList = formkey>
	...
	<table border="0" cellpadding="0" cellspacing="4" width="95%" class="formtext" align="center">
		...
		<tr>
			...
			<td width="20%">[<a href="#self#?fuseaction=shopping.admin&taxes=Local&edit=#local_ID#&code_id=#attributes.code_id##Request.Token2#">edit</a>] [<a href="#self#?fuseaction=shopping.admin&taxes=local&delete=#local_ID#&code_id=#attributes.code_id#&formkey=#Hash(formkey,"SHA-256")##Request.Token2#">delete</a>]</td>
		</tr>
		</cfoutput>
	</table>
<cfelse>
