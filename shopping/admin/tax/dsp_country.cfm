...
<cfif GetTaxes.RecordCount>	
	...
	<cfset session.formKeys.CountryTaxList = formkey>
	...
	style="color:#<cfoutput>#Request.GetColors.InputTText#</cfoutput>">
		...
		<tr>
			...
			<td width="20%">[<a href="#self#?fuseaction=shopping.admin&taxes=country&edit=#Tax_ID#&code_id=#attributes.code_id##Request.Token2#">edit</a>] [<a href="#self#?fuseaction=shopping.admin&taxes=country&delete=#Tax_ID#&code_id=#attributes.code_id#&formkey=#Hash(formkey,"SHA-256")##Request.Token2#">delete</a>]</td>
		</tr>
		</cfoutput>
	</table>
<cfelse>
