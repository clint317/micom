...
<cfswitch expression="#giftwrap#">
	...
	<cfcase value="edit">
		...
		<cfloop list="#fieldlist#" index="counter">
			<cfset attributes[counter] = qry_get_giftwrap[counter][1]>
		</cfloop>
...
#Request.AppSettings.WeightUnit#
 ...
 <!--- display --->
			<tr>
				...
				<td></td>
			 	<td><input type="radio" name="Gift_Display" value="1" #doChecked(attributes.Display)# /> Yes 
				&nbsp;&nbsp;<input type="radio" name="Gift_Display" value="0" #doChecked(attributes.Display,0)# /> No
				</td>
			</tr>	
