...
<!--- Output Basket Headers --->
	...
	<tr>
		<td colspan="6" style="BACKGROUND-COLOR: ###Request.GetColors.linecolor#;"><img src="#Request.ImagePath#spacer.gif" alt="" height="1" width="1" /></td>	
	</tr>
...
<cfloop query="GetOrder">
	...
	<cfquery name="GetProdAddons" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
		...
		WHERE PA.Product_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#product_id#">
	</cfquery>	
