...
<cfif isdefined("attributes.submit_form") or len(attributes.product_ID)>
	...
	<cfquery name="LookupProduct" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
	...
	<cfelse>
		...
		<cfif len(attributes.SKU)>
			AND SKU LIKE <cfqueryparam cfsqltype="cf_sql_varchar" value="%#attributes.sku#%">
	...
	<cfelseif LookupProduct.recordcount IS 1>
		...
		<cfinclude template="put_product_orderform.cfm">
