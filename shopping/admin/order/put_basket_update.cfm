...
<cfif GetOrder.Tax>
	...
	<form action="#self#?fuseaction=shopping.admin&order=display&order_no=#attributes.order_no##request.token2#" method="post" name="orderform">
...
objForm.Freight.description = "freight charges";
objForm.Freight.validateNumeric();

objForm.ShippingTotal.description = "shipping";
objForm.ShippingTotal.validateNumeric();

objForm.AdminCredit.description = "Store Credit";
objForm.AdminCredit.validateNumeric();
