...
<a href="JavaScript:newWindow=window.open( '#self#?fuseaction=shopping.admin&order=print&print=po&Order_No=#attributes.order_no#&account_id=#account_id##Request.Token2#', 'PO', 'width=900,height=800,toolbar=1,location=0,directories=0,status=0,menuBar=1,scrollBars=1,resizable=1' ); newWindow.focus()">View/Print</a>
<cfif po_open is 1> | 
