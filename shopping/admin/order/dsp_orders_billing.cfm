...
<cfset fieldlist="order,order_no,customer,orderdate,filled,paid,affiliate,status,sort,sortorder,offlinepayment">
...
<cfif qry_get_Orders.recordcount gt 0>					
	...
	<cfloop query="qry_get_Orders" startrow="#PT_StartRow#" endrow="#PT_Endrow#">
		...
		<td><cfif edituser><cfif uid><a href="#self#?fuseaction=users.admin&user=edit&uid=#uid#&XFA_success=#URLEncodedFormat(addedpath)##Request.Token2#"><cfelse><a href="##" onclick="Guest(); return false;"></cfif>#firstname#  #lastname#</a>	
