...
<cfoutput>
		<tr>
			...
			<td width="65%">
			<input type="text" name="Username" value="#attributes.Username#" class="formfield" size="40" maxlength="150"/><br/>
		...
		<tr>
			...
			<td></td>
			<td width="65%">
			<input type="text" name="CCServer" class="formfield" value="#attributes.CCServer#" size="40" maxlength="150"/><br/>
		...
		<tr>
			...
			<td></td>
			<td width="65%">
			<input type="text" name="Password" class="formfield" value="#attributes.Password#" size="40" maxlength="150"/><br/>
			<span class="formtextsmall">REQUIRED if Auto Settle set to No.</span>
			</td>	
		</tr>
