...
<cfoutput>
		...
		<cfif attributes.TestConnectivity is "YES">
			<cfmodule
				template="../../../checkout/creditcards/shift4/shift4otn.cfm"
				Result = "OTN"
			...
			<cfif OTN.ErrorIndicator is "Y">
				...
				<cfif OTN.PrimaryErrorCode GTE 98000>
					<tr><td colspan="3"><cfdump var="#OTN#" label="OTN"></td></tr>
				</cfif>
			<cfelse>
				<tr>
		...
		<tr>
			...
			<td>
			<input type="text" name="Username" value="#get_Shift4OTN_Settings.Username#" size="40" maxlength="50" class="formfield"/>
			</td>	
		</tr>
		...
		<tr>
			...
			<td style="background-color: ###Request.GetColors.formreq#;"></td>
			<td>
			<input type="Password" name="Password" autocomplete="off" value="***same/same***" size="40" maxlength="50" class="formfield"/>
			</td>	
		</tr>
		...
		<tr>
			<td colspan="3"><br /><strong>i4Go Settings:</strong> &nbsp;These settings insure that your web site and web server never handle credit card data; instead only tokens. The only drawback is that your customers are required to have scripting enabled to enter payment information for an order. While these fields are optional, it is HIGHLY recommended that you use this feature.<br /><br /></td>
		</tr>
		<tr>
			<td align="RIGHT">i4Go Host Address </td>
			<td width="3">&nbsp;</td>
			<td>
			<input type="text" name="i4GoURL" value="#get_Shift4OTN_Settings.i4GoURL#" size="50" maxlength="35" class="formfield"/>
			</td>	
		</tr>
		<tr>
			<td align="RIGHT">Account ID <font size="-2"><br/>(issued by i4Go)</font> </td>
			<td width="3">&nbsp;</td>
			<td>
			<input type="text" name="i4GoAccountID" value="#get_Shift4OTN_Settings.i4GoAccountID#" size="20" maxlength="10" class="formfield"/>
			</td>	
		</tr>
		<tr>
			<td align="RIGHT">Site ID <font size="-2"><br/>(issued by i4Go)</font> </td>
			<td width="3">&nbsp;</td>
			<td>
			<input type="text" name="i4GoSiteID" value="#get_Shift4OTN_Settings.i4GoSiteID#" size="20" maxlength="10" class="formfield"/>
			</td>	
		</tr>
		
		<tr>
			<td colspan="3"><br /><strong>IMPORTANT NOTE:</strong> The best setting for most web stores, and the required setting for web stores that ship physical goods, the following Transaction Type option should be set to AUTH and the 'Use Billing Tab' option in the Payment Options should be ENABLED. Web stores that sell subscriptions, services or downloadables, this option can be set to SALE and the 'Use Billing Tab' option can be DISABLED but by using these settings, you will loose the order details in $$$ ON THE NET.<br /><br /></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="3"><br /><strong>Proxy Server Settings:</strong> &nbsp;These settings are optional and only required if your web server uses a proxy server for outbound communication. Most web servers do not use proxy servers. Leave Server Name blank if unused. Contact your ISP or system administrator if you are not sure.<br /><br /></td>
		</tr>
		<tr>
