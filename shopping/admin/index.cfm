	...
	<cfif ispermitted>
		...
		<cfswitch expression="#attributes.shipping#">
			...
			<cfcase value="settings">
				<cfinclude template="shipping/dsp_ship_types.cfm">
			</cfcase>	
			
			<cfcase value="editsettings">				
				<cfset attributes.box_title="Shipping Settings">
				<cfinclude template="shipping/act_settings.cfm">
				<cfif attributes.action IS "delete" or len(attributes.error_message)>
			...
			<cfcase value="fedexregister">
				...
				<cfelseif isdefined("attributes.submit_fedex")>
					...
					<cfset attributes.XFA_success="fuseaction=shopping.admin&shipping=settings">
					<cfset attributes.box_title="FedEx Registration">
					<cfset attributes.message = "FedEx Registration Complete!">
					<cfinclude template="../../includes/admin_confirmation.cfm">	
				<cfelse>
			...
			<cfcase value="free">
				<cfif isdefined("attributes.submit_free")>
					...
					<!--- save confirmation --->
					<cfset attributes.XFA_success="fuseaction=shopping.admin&shipping=editsettings&ship_id=#session.ship_id#">
...
<cfelseif isdefined("attributes.payment")>		
	...
	<cfif ispermitted>
		...
		<cfswitch expression="#attributes.payment#">
			...
			<cfcase value="paypal">
				<cfif isdefined("attributes.submit_paypal")>
					<cfinclude template="payment/gateways/act_paypalexpress.cfm">
					<cfset attributes.XFA_success="fuseaction=shopping.admin&payment=cards">
					<cfset attributes.box_title="PayPal Express Settings">
					<cfinclude template="../../includes/admin_confirmation.cfm">	
				<cfelse>
					<cfinclude template="payment/gateways/dsp_paypalexpress.cfm">
				</cfif>
			</cfcase>	
			
			<cfcase value="cresecure">
				<cfif isdefined("attributes.submit_cresecure")>
					<cfinclude template="payment/gateways/act_cresecure.cfm">
					<cfset attributes.XFA_success="fuseaction=shopping.admin&payment=cards">
					<cfset attributes.box_title="CRE Secure Settings">
					<cfinclude template="../../includes/admin_confirmation.cfm">	
				<cfelse>
					<cfinclude template="payment/gateways/dsp_cresecure.cfm">
				</cfif>
			</cfcase>	
...
<cfelseif isdefined("attributes.temporder")>		

	<cfset Webpage_title = "Abondoned Carts #attributes.temporder#">
	
	<cfswitch expression="#attributes.temporder#">
		<cfcase value="search">
				...
				<cfif ispermitted>
					...
					<!--- <cfif isdefined("attributes.batchprocess")>
						<cfinclude template="temporder/act_orders.cfm">
						<cfset attributes.basket_num = "">
					</cfif> --->
					
					<cfinclude template="temporder/qry_get_orders.cfm">
					<cfinclude template="temporder/dsp_temporders.cfm">
			...
			<cfcase value="display">
				...
				<cfif ispermitted>
					...
					>
						...
						<cfelseif isdefined("attributes.refund_submit")>
							<cfinclude template="order/act_order_refund.cfm">
...
<!--- order detail ---------------->
			...
			<cfcase value="viewterms">
				...
				>
				<cfif ispermitted>
					<cfinclude template="order/dsp_ordertems.cfm">
				</cfif>		
			</cfcase>
	...
	<cfif ispermitted>
		...
		<cfswitch expression="#attributes.po#">
			...
			<cfcase value="add">
				...
				<cfparam name="attributes.xfa_success" default="fuseaction=shopping.admin&order=display&order_no=#attributes.order_no#">
			...
			<cfcase value="edit">
				<cfif isdefined("attributes.order_no")>
					<cfparam name="attributes.xfa_success" default="fuseaction=shopping.admin&order=display&order_no=#attributes.order_no#">
				<cfelse>
					<cfparam name="attributes.xfa_success" default="fuseaction=shopping.admin&po=list&open=1">
				</cfif>
