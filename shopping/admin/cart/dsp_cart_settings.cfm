...
<tr>
	<td align="RIGHT">
	Use Wishlists:</td><td style="background-color: ###Request.GetColors.formreq#;"></td>
...
<tr><td>&nbsp;</td><td colspan="2"><span class="formtextsmall">Sets if you will ship orders outside your home country. Be sure to configure the User and Shipping settings as appropriate.</span></td></tr>
	...
	<tr><td>&nbsp;</td><td colspan="2"><span class="formtextsmall">Allows user to skip the address form if they have default addresses entered. This should be turned off if you use PayPal Express Checkout.</span></td></tr>
...
<tr>
		...
		<td></td>
		<td><input type="text" name="CustomText#num#" value="#get_order_settings['CustomText' & num][1]#" size="50" maxlength="255" class="formfield"/></td>
	</tr>
...
<tr>
		...
		<td></td>
		<td><input type="text" name="CustomSelect#num#" value="#get_order_settings['CustomSelect' & num][1]#" size="50" maxlength="100" class="formfield"/></td>
	</tr>
	
<tr>
		<td align="RIGHT" valign="top">Selectbox #num# Choices:</td>
		<td></td>
		<td><textarea cols="30" rows="2" name="CustomChoices#num#" class="formfield">#get_order_settings['CustomChoices' & num][1]#</textarea></td>
	</tr>
