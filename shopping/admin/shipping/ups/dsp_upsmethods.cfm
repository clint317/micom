...
<cfquery name="GetOrigin" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
	SELECT Origin FROM #Request.DB_Prefix#UPS_Settings
</cfquery>

<cfquery name="UPSMethods" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
