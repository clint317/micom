...
<!--- <br/><input type="checkbox" name="UseSmartPost" value="1" #doChecked(GetFedEx.UseSmartPost)# />FedEx SmartPost<sup>&reg;</sup> --->
			</td>	
		</tr>
			<tr><td colspan="2"></td><td class="formtextsmall">
...
objForm.required("MaxWeight,Dropoff,Packaging,Debug");
