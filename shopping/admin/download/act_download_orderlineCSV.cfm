...
<cfset FilePath = GetDirectoryFromPath(ExpandPath(Request.StorePath)) & "shopping#request.slash#admin#request.slash#download">
...
<cfset MaxProds = iif(isNumeric(GetMax.ItemMax), GetMax.ItemMax, 0)>
