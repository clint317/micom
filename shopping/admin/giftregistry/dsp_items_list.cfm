...
#registrant# <cfif len(OtherName)> &amp; #OtherName#</cfif>  <br/>
		...
		<cfoutput>
<button class="formbutton" onclick="JavaScript: newWindow = openWin( '#request.self#?fuseaction=shopping.admin&giftregistry=AddProduct&giftregistry_ID=#attributes.giftregistry_ID##request.token2#', 'Products', 'width=650,height=550,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=1,resizable=1' ); newWindow.focus()">Add Product</button> &nbsp;&nbsp;</cfoutput>
		</td>
	</tr>
</table>
