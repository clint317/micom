...
<cfset fieldlist="giftregistry,uid,uname,giftregistry_ID,name,city,giftregistry_Type,event_Date,display_status">
...
<cfif qry_get_giftregistrys.recordcount gt 0>
	<cfloop query="qry_get_giftregistrys" startrow="#PT_StartRow#" endrow="#PT_EndRow#">
		<tr>
			...
			<td colspan="3">
			<a href="#Request.StoreSelf#?fuseaction=shopping.giftregistry&do=display&giftregistry_ID=#giftregistry_ID##request.token2#" target="store">#left(Event_name,41)#<cfif len(Event_name) gt 41>...</cfif></a>
			</td>
