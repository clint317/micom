...
<cfswitch expression="#giftregistry#">
	...
	<cfcase value="edit">
		...
		<cfloop list="#fieldlist#" index="counter">
			<cfset attributes[counter] = qry_get_giftregistry[counter][1]>
		</cfloop>
...
<cfquery name="GetUser" datasource="#Request.ds#" username="#Request.DSuser#" password="#Request.DSpass#" >
	...
	WHERE User_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#variables.UID#">
</cfquery>

<cfinclude template="../../../includes/charCount.js">

<cfhtmlhead text="<script type='text/javascript' src='#Request.StorePath#includes/initialcaps.js'></script>">
