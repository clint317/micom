...
<cfset fieldlist="po,order_no,order_num,po_no,account_id,printdate,status,shipdate,open">
...
href="#self#?fuseaction=users.admin&account=edit&account_ID=#account_ID#&XFA_success=#URLEncodedFormat(addedpath)##Request.Token2#">#account_name#</a><cfelse>#account_name#</cfif>
		...
		<td>	
		<a href="JavaScript:newWindow=window.open( '#self#?fuseaction=shopping.admin&order=print&print=po&Order_No=#order_no#&account_id=#account_id##Request.Token2#', 'PO', 'width=900,height=800,toolbar=1,location=0,directories=0,status=0,menuBar=1,scrollBars=1,resizable=1' ); newWindow.focus()">view</a>
		</td>	
