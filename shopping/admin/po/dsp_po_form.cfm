...
<cfloop list="#fieldlist#" index="counter">
	<cfset attributes[counter] = qry_get_po[counter][1]>
</cfloop>
...
<cfoutput>
	...
	<!--- Order Number - not editable --->
		<tr valign="top">
			...
			<td></td>
			<td class="formtitle">#(qry_get_po.Order_No + Get_Order_Settings.BaseOrderNum)#</td>
		</tr>
	...
	<!--- PO Date --->
		<tr valign="top">
			...
			<img src="#Request.ImagePath#spacer.gif" alt="" height="1" width="4" /></td>
