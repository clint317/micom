...
<!--- Retrieves the information for the Products Totals Report for stores using SKU options. Called by dsp_reports.cfm --->
...
<!--- This page is called by viewreport.cfm and is used to output the product totals --->
