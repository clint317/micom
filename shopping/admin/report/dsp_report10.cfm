...
<!--- Displays the Top Products by Total Sales Report for stores using SKU options. Called by dsp_reports.cfm --->

<tr><td colspan="2" align="CENTER"><cfoutput>
<strong>TOP PRODUCTS BY TOTAL SALES (by SKU) - #LSDateFormat(StartDate, "mmm d, yyyy")# - #LSDateFormat(ToDate, "mmm d, yyyy")#</strong><br/>&nbsp;
</td></tr>
</cfoutput>
...
<cfoutput query="GetOrders" maxrows="10">
