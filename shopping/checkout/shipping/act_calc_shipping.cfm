...
<cfscript>
	...
	if (TotalShip IS 0) {
		...
		if (get_Order_Settings.Giftcard is 0 AND get_Order_Settings.Delivery is 0 AND get_Order_Settings.Coupons is 0 AND NOT len(get_order_Settings.CustomText1) AND NOT len(get_order_Settings.CustomSelect1)) {
