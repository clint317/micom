...
<cfloop list="#attributes.fieldlist#" index="counter">
	<cfparam name="attributes.#counter#" default= "#gettemporder[counter][1]#">
</cfloop>
...
<!-- start shopping/checkout/dsp_ship_form.cfm -->
<div id="dspshipform" class="shopping">
...
<cfoutput>		
	...
	<table cellspacing="0" border="0" cellpadding="10" class="formtext" style="color:###Request.GetColors.InputTText#">
		...
		<br/><br/><img src="#Request.ImagePath#icons/ups_smlogo.jpg" alt="" width="32" height="32" 
		...
		<br/><br/><img src="#Request.ImagePath#icons/hdr_uspsLogo.gif" width="160" height="60" 
		...
		<br/><br/><img src="#Request.ImagePath#icons/fedex_sm.gif" width="130" height="50" 
		...
		<br/><br/><img src="#Request.ImagePath#isbutton.gif" width="258" height="68" alt="Rates by Intershipper"
		border="0" />
		</cfif>
...
<!-- end shopping/checkout/dsp_ship_form.cfm -->
