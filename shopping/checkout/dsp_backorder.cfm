...
<!-- start shopping/checkout/dsp_backorder.cfm -->
<div id="dspbackorder" class="shopping">
...
<form action="#XHTMLFormat('#Request.StoreSelf#?fuseaction=shopping.basket&Recalc=Yes#Request.Token2#')#" method="post">
...
<!-- end shopping/checkout/dsp_backorder.cfm -->
