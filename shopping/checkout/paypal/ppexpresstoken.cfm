...
<cfset ReturnURL = "#XHTMLFormat('#Request.SecureSelf#?fuseaction=shopping.checkout&step=pp_doexpress&redirect=yes#Request.AddToken#')#">

<cfif len(attributes.Token)>
	<cfset CancelURL = "#XHTMLFormat('#Request.SecureSelf#?fuseaction=shopping.checkout&step=shipping&redirect=yes#Request.AddToken#')#">
<cfelse>
	<cfset CancelURL = "#XHTMLFormat('#Request.SecureSelf#?fuseaction=shopping.checkout&redirect=yes#Request.AddToken#')#">
</cfif>
