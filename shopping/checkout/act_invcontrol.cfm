...
<cfloop index="num" from="1" to="#ListLen(NewItemNums)#">
	...
	<cfquery name="CheckInv" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
	...
	<cfelseif CheckInv.Prod_Type is "product">
		...
		<cfquery name="CheckOInv" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
