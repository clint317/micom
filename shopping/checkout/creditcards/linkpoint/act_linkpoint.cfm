...
<!--- Used for returned funds inside the system --->
<cfset Chargetype_Refund = "REFUND">
<!--- Used for returned funds outside the system --->
<cfset Chargetype_Credit = "CREDIT">
<!--- Action to void an unsettled order --->
<cfset Chargetype_Void = "VOID">
