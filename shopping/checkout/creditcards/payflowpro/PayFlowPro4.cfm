...
<!--- customer data --->
<cfset param = param & "&FIRSTNAME=#attributes.firstname#&LASTNAME=#attributes.lastname#&COMPANYNAME=#attributes.company#&STREET=#attributes.address#&CITY=#attributes.city#&STATE=#attributes.state#&ZIP=#attributes.zip#&BILLTOCOUNTRY=#attributes.country#&PHONENUM=#attributes.phone#&EMAIL=#attributes.email#&INVNUM=#attributes.order#&CVV2=#attributes.CVV2#">
