...
<cfset urllist="">
<cfset variables.rawCFHttpResults=ArrayNew(1)>
<cfloop condition="1 EQ 1">
	...
	<cfloop condition="1 EQ 1">
		...
		<cftry>
			...
			<cfset tmp=ArrayAppend(variables.rawCFHttpResults,cfhttp)>
			<cfcatch type="Any">
				<cfset cfhttp_statusCode="EXCEPTION">
				<cfset cfhttp_cfCatch=CFCatch>
...
<cfset VARIABLES.Result.cfhttp=variables.rawCFHttpResults>
<cfif IsDefined("cfhttp_cfCatch")>
	<cfset VARIABLES.Result.cfhttp_cfCatch=cfhttp_cfCatch>
</cfif>
