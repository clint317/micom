...
<cfif get_order_settings.EmailUser>
	...
	<cftry>
		...
		<cfset Application.objGlobal.sendAutoEmail(Email=GetCustomer.Email,MailAction='OrderRecvdCustomer',MergeContent=mergeContent)>
...
<cfif get_order_settings.EmailAffs>
	...
	<cfif GetAffiliate.RecordCount>
		...
		<cftry>
			...
			<cfset Application.objGlobal.sendAutoEmail(UID=GetAffiliate.User_ID,MailAction='OrderRecvdAffiliate',MergeContent=mergeContent)>
