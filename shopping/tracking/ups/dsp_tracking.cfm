...
<!-- start shopping/tracking/ups/dsp_tracking.cfm -->
...
>
	<tr>
		...
		<img src="#Request.ImagePath#icons/ups_colorlogo.jpg" alt="" width="68" height="68" border="0" /></td><td colspan="2">
...
<tr><td width="50"><br/>
<cfoutput>
<img src="#Request.ImagePath#icons/ups_smlogo.jpg" alt="" width="32" height="32" border="0" align="left" /></cfoutput>
</td><td colspan="3"><br/>
<i>UPS, UPS brandmark, and the Color Brown are trademarks of<br/>
...
<!-- end shopping/tracking/ups/dsp_tracking.cfm -->
