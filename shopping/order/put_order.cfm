...
<!-- start shopping/order/put_order.cfm -->
<div id="putinvoiceorder" class="shopping">
	
<cfif len(errormess)>

	<cfoutput>
	<div class="formtext" align="center"><p><b>#errormess#</b></p></div>
	</cfoutput>
	...
	<td colspan="3">
			...
			<cfelseif get_Order_Settings.CCProcess IS "Shift4OTN">
				...
				<table border="0" cellpadding="2" cellspacing="2" align="center">
					<cfoutput query="GetCardData">
						<tr align="left">
							<td><strong>#CardType#</strong></td>
							<cfif IsDefined("InvoiceNum") and InvoiceNum NEQ "">
								<td>#InvoiceNum#</td>
							</cfif>
							<td>
								<cfif len(EncryptedCard) AND Type IS "Admin">
									<cftry>
										...
										<cfmodule template="../../customtags/dsptoken.cfm" cardnumber="#CardNumber#" token="#crypt.value#">
									<cfcatch type="Any">
										#CardNumber# (number failed to decrypt)
									</cfcatch>
									</cftry>
								<cfelse>
									#CardNumber#
...
<img src="#Request.ImagePath#icons/ups_smlogo.jpg" alt="" width="32" height="32" border="0" align="left" /><i>UPS, UPS brandmark, and the Color Brown are trademarks of United
...
<!-- end shopping/order/put_order.cfm -->
