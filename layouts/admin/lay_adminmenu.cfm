...
<!-- Begin Spry Includes -->
<script type="text/javascript" src="#Request.StorePath#includes/spry/xpath.js"></script>
<script type="text/javascript" src="#Request.StorePath#includes/spry/SpryData.js"></script>
<script type="text/javascript" src="#Request.StorePath#includes/spry/SpryAccordion.js"></script>
<!-- End Spry Includes -->
...
<link href="#Request.StorePath#css/SpryAccordion.css" rel="stylesheet" type="text/css" />
...
<cfoutput>
<script type="text/javascript" src="#Request.StorePath#includes/tooltips/wz_tooltip.js"></script>
</cfoutput>
