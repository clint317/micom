...
<cftry>
	...
	<div id="Errors_Div" spry:region="txtPending"><a href="#self#?fuseaction=home.admin&error=list#Request.Token2#" onmouseover="return escape(site6)" target="AdminContent"><strong>Site Errors</strong></a><br/> <span style="color: red"><span id="errorcount" spry:content="{Errors}">#innertext#</span> pending.</span></div>
