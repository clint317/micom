...
<cfoutput>
		<form name="featurejump" action="#self#?fuseaction=feature.admin&do=list#request.token2#" method="post" target="AdminContent" class="nomargins">
		<input type="text" name="string" value="enter Feature ID..." size="20" maxlength="100" class="accordionTextBox" onfocus="featurejump.string.value = '';" onchange="submit();" />
		</form>
