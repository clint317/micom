...
<!--- To use with other DHTML menus, just customize the doPageMenu output below with classes and/or tags as needed --->
...
<!--- Call the function that retrieves the page tree and creates the XML string for it --->
<!--- This function accepts two parameters, the Parent_ID for the menu and the number of levels to show --->
<cfset xmlstring = Application.objMenus.xmlPageTreeCreator(0,10)>
<!--- Do it --->
