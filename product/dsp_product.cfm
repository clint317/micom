...
<cfhtmlhead text='
	...
	<link rel="stylesheet" href="#Request.StorePath#css/thumbnailviewer.css" type="text/css" />
	<script type="text/javascript" src="#Request.StorePath#includes/openwin.js"></script>
	<script type="text/javascript" src="#Request.StorePath#includes/thumbnailviewer.js">
	/***********************************************
...
<br/>
	...
	<cfmodule  template="../access/secure.cfm"
		...
		>		
		<cfoutput>
		[<a href="#XHTMLFormat('#Request.SecureSelf#?fuseaction=product.admin&do=edit&product_id=#attributes.product_id##Request.AddToken#')#" #doAdmin()#>Edit Product #attributes.product_id#</a>]<br/></cfoutput>
	</cfmodule>
