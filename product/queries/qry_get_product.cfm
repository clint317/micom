...
<cftry>
	...
	<cfquery name="qry_get_products" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#" maxrows="1">
	...
	<cfquery name="GetProdOpts" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
	...
	<cfquery name="GetProdAddons" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
	...
	<cfif request.appsettings.productreviews>
		<cfquery name="qry_prod_reviews" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
	...
	<cfquery name="GetGroupPrice" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
