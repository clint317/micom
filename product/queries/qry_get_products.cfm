...
<!--- Get products --->
<cfquery name="qry_get_products" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#" cachedwithin="#Cached#">
...
<cfif request.appsettings.productreviews>
	<cfquery name="GetReviews" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
