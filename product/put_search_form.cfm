...
<cfoutput>
<!-- start code added by product/put_search_form.cfm -->
...
<!-- end code added by product/put_search_form.cfm -->
</cfoutput>
</cfsavecontent>

<cfhtmlhead text="#jscript#">

<!-- start product/put_search_form.cfm -->	
<div id="putsearchform" class="product">
<cfoutput>
...
<cfset ending = "#val(request.qry_get_subcats.RecordCount/2)#">
			  ...
			  <a href="javascript:DoCatSearch('#category_id#')" class="cat_text_list">#name#</a>
				<br/>
			</cfloop>
				</td>
				<td align="left" valign="top"  width="50%">
...
<!-- end product/put_search_form.cfm -->	
