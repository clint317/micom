...
<cfif PickProd>
	...
	<cfif len(attributes.UnderCategory_id) And attributes.UnderCategory_id IS NOT 0>
		...
		<cfquery name="CountProds" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
			SELECT P.Product_ID
...
<cfif attributes.product_id gt 0>
	...
	<!-- start product/put_productofday.cfm -->
	<div id="putproductofday" class="products">
	...
	<!-- end product/put_productofday.cfm -->
