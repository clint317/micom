...
<cfloop list="Anonymous,Anon_Name,Anon_Loc,Anon_Email,Title,Comment,Rating" index="counter">
	<cfparam name="attributes[counter]" default="#qry_get_review[counter][1]#">
</cfloop>
...
<!-- start product/reviews/dsp_edit_form.cfm -->
<div id="dspeditform" class="product">
...
<input type="hidden" name="product_ID" value="#HTMLEditFormat(attributes.product_ID)#"/>
...
box_title="#formaction# #sanitize(attributes.box_title)#"
width="550"
required_fields="1"
>
    ...
    <tr align="left">
	  ...
	  <td></td>
      <td><input type="text" name="anon_email" size="38" value="#HTMLEditFormat(attributes.anon_email)#" class="formfield" maxlength="75"/><br/>
	...
	<tr align="left">
	  ...
	  <input type="text" name="anon_name" size="33"  maxlength="50" value="#HTMLEditFormat(attributes.anon_name)#" class="formfield"/><br/>
    ...
    <tr align="left">
      <td colspan="2"></td>
      <td ><br/>
	  <input type="submit" name="submit_review" value="#formaction# #sanitize(attributes.box_title)#" class="formbutton"/>
...
<!-- end product/reviews/dsp_edit_form.cfm -->
