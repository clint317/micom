...
<!-- start product/reviews/dsp_review.cfm -->
<div id="dspreview" class="product">
...
<strong>#HTMLEditFormat(Title)#</strong><br/>
...
<br/>
#HTMLEditFormat(Comment)#
<br/><br/><strong>Rated:</strong> <img src="#Request.ImagePath#icons/#Rating#_med_stars.gif" alt="#Rating# Stars" border="0" />
...
<ul>
	<li><a href="javascript:newWindow=openWin('#XHTMLFormat('#self#?fuseaction=home.email&mailto=editor&page=#self#?#cgi.query_string#')#','Email','width=600,height=450,toolbar=0,location=0,directories=0,status=0,menuBar=0,scrollBars=1,resizable=1'); newWindow.focus()">Alert us of an offensive message</a></li>
...
<!-- end product/reviews/dsp_review.cfm -->
