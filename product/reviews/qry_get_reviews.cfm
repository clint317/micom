...
<cfif isNumeric(attributes.product_ID)>
	<cfquery name="GetDetail"  datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
...
<cftry>
	...
	<cfquery name="qry_get_reviews"  datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#" maxrows="#attributes.maxrows#">
	...
	WHERE 
		...
		<cfif Len(attributes.recent_days)>
		Posted >= <cfqueryparam cfsqltype="cf_sql_timestamp" value="#DateAdd("y",-attributes.recent_days,Now())#"> AND</cfif>	
