...
<!-- start product/reviews/put_search_header.cfm -->
<div id="putreviewsearch" class="product">
...
<cfelseif isdefined("GetDetail.recordcount")>
...
<!-- end product/reviews/put_review_search.cfm -->
