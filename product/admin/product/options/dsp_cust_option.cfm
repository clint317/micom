...
<cfelse><!--- edit custom--->
		...
		<cfloop list="#fieldlist#" index="counter">
			<cfset attributes[counter] = qry_get_option[counter][1]>
		</cfloop>
...
<cfmodule template="../../../../customtags/format_output_admin.cfm"
 ...
 <!--- display --->
		<tr>
			...
			<td style="background-color: ###Request.GetColors.formreq#;"></td>
		 	<td>
			<input type="radio" name="Opt_Display" value="1" #doChecked(attributes.Display)# /> Yes &nbsp; 
			<input type="radio" name="Opt_Display" value="0" #doChecked(attributes.Display,0)# /> No
			</td>
			</tr>		
...
<cfif Number>
		...
		<cfoutput query="qry_get_Opt_Choices">
			...
			<tr>
				<td><input type="text" name="ChoiceName#currentrow#" value="#HTMLEditFormat(ChoiceName)#" size="25" maxlength="150" class="formfield"/></td>
...
<td align="center"><input type="checkbox" name="Opt_Display#currentrow#" #doChecked(Display)# class="formfield"/></td>
...
document.write('<td align="LEFT"><br/>\n');
	...
	document.write('<tr><td><input type="text" name="ChoiceName' + i + '" size="25" maxlength="150" class="formfield"/></td>\n');
...
document.write('<td align="center"><input type="checkbox" name="Opt_Display' + i + '" class="formfield" checked="checked" /></td>\n');
