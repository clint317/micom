...
<!--- This page is used to run the javascript checks for the option forms. Called from dsp_cust_option.cfm and dsp_std_option2.cfm --->
...
function CancelForm () {
	<cfoutput>location.href = "#self#?fuseaction=product.admin&product_ID=#attributes.product_id#&cid=#attributes.cid#&do=options&redirect=yes#request.token2#";</cfoutput>
	}
</script>
