...
<cfset fieldlist="Product_ID,Name,short_desc,long_desc,sm_image,lg_image,enlrg_image,sm_title,lg_title,passparam,color_id,display,priority,accesskey,Highlight,sale,Hot,Reviewable,UseforPOTD,dateadded,prod_type,mfg_account_id,metadescription,keywords,titletag,user_id">	
		...
		<cfswitch expression="#attributes.do#">
			...
			<cfcase value="edit">
				...
				<cfloop list="#fieldlist#" index="counter">
					<cfset attributes[counter] = qry_get_product[counter][1]>
				</cfloop>
...
<cfmodule template="../../../customtags/format_admin_form.cfm"
 ...
 <!--- display --->
			<tr>
				...
				<td style="background-color: ###Request.GetColors.formreq#;"></td>
				<td colspan="3"><input type="radio" name="prod_display" value="1" #doChecked(attributes.display)# /> Yes  
				&nbsp;&nbsp;<input type="radio" name="prod_display" value="0" #doChecked(attributes.display,0)# /> No
			</td>
			</tr>			
 ...
 <!--- Category_id --->		
			<tr>
				...
				<td></td>
				<td colspan="3">
				<select name="CID_list" size="#iif(qry_get_cat_picklist.RecordCount LT 10,qry_get_cat_picklist.RecordCount,10)#" multiple="multiple" class="formfield">	
...
<!--- Listing Title --->
 ...
 <!--- Small Title --->
			<tr>
				...
				<td></td>
				<td colspan="3"><input type="text" name="Sm_Title" size="33" maxlength="100" class="formfield" value="#attributes.Sm_Title#"/> <a href="JavaScript: newWindow = openWin('#self#?fuseaction=home.admin&select=image&fieldname=Sm_Title&fieldvalue=#attributes.Sm_Title#&dirname=/products&user=#attributes.user_ID#', 'images', 'width=850,height=700,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=0,resizable=1'); newWindow.focus()" class="formtextsmall">Image Manager</a>
				</td>
			</tr>
 ...
 <!--- Short Description --->
			<tr>
				...
				<cfmodule 
					...
					toolbarSet="Basic" 
					config="#config#"
					Value="#Application.objGlobal.doImgPaths(attributes.Short_Desc)#"
					/>
				</td>
			</tr>
...
<!--- Large Title --->
			<tr>
				<td align="RIGHT">Title Image:</td>
				<td></td>
				<td colspan="3"><input type="text" name="Lg_Title" size="33" maxlength="100" class="formfield" value="#attributes.Lg_Title#"/> <a href="JavaScript: newWindow = openWin('#self#?fuseaction=home.admin&select=image&fieldname=Lg_Title&fieldvalue=#attributes.Lg_Title#&dirname=/products&user=#attributes.user_ID#', 'images', 'width=850,height=700,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=0,resizable=1'); newWindow.focus()" class="formtextsmall">Image Manager</a>
				</td>
			</tr>		
 ...
 <!--- Large Image --->
			<tr>
				...
				<a href="JavaScript: newWindow = openWin('#self#?fuseaction=home.admin&select=image&fieldname=Lg_Image&fieldvalue=#linkImage#&dirname=/products&user=#attributes.user_ID#', 'images', 'width=850,height=700,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=0,resizable=1'); newWindow.focus()" class="formtextsmall">Image Manager</a><br/>
...
<!--- Enlarged Image --->
			<tr>
				...
				<td></td>
				<td colspan="3"><input type="text" name="Enlrg_Image" size="33" maxlength="100" class="formfield" value="#attributes.Enlrg_Image#"/> <a href="JavaScript: newWindow = openWin('#self#?fuseaction=home.admin&select=image&fieldname=Enlrg_Image&fieldvalue=#attributes.Enlrg_Image#&dirname=/products&user=#attributes.user_ID#', 'images', 'width=850,height=700,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=0,resizable=1'); newWindow.focus()" class="formtextsmall">Image Manager</a><br/>
 ...
 <!--- Long Description --->
			<tr>
				...
				<cfmodule 
					...
					height="500"
					config="#config#"
					Value="#Application.objGlobal.doImgPaths(attributes.Long_Desc)#"
					/>
			</td>
			</tr>			
...
<!--- Custom palette --->
			<tr>
				...
				<td></td>
		 		<td colspan="3">
				<select name="prod_color_id" size="1" class="formfield" class="formfield">
