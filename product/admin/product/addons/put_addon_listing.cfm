...
<cfloop query="qry_Get_Addons">
	...
	<cfelseif DisplayType IS "calendar">
		#UserPrompt#: 
		<input type="text" name="Prompt" value="" size="15" maxlength="150" class="formfield"/> <img src="#Request.ImagePath#icons/Calendar2.gif" alt="" width="16" height="16" border="0" align="top" />
