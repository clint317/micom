...
<cfelse>
		...
		<cfloop list="#fieldlist#" index="counter">
			<cfset attributes[counter] = qry_get_addon[counter][1]>
		</cfloop>
	 	...
	 	<!--- Name --->
			<tr>
				...
				<td style="background-color: ###Request.GetColors.formreq#;"></td>
		 		<td><input type="radio" name="Add_Display" value="1" #doChecked(attributes.Display)# /> Yes &nbsp; 
					<input type="radio" name="Add_Display" value="0" #doChecked(attributes.Display,0)# /> No
				</td></tr>
