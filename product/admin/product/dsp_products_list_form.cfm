...
<cfset fieldlist="do,name,sku,display_status,highlight,potd,sale,hot,type,account_id,cid,nocat">
...
<!---- Category Browse --------->		
	<tr>
		...
		<tr>
			<td colspan="12" style="BACKGROUND-COLOR: ###Request.GetColors.inputHBgcolor#;">
	...
	<tr>
		...
		<th align="center" nowrap="nowrap">POTD</th>
...
<cfquery name="GetStockNums" datasource="#Request.ds#" username="#Request.DSuser#" password="#Request.DSpass#">
...
<input type="hidden" name="OptQuant#Product_ID#" value="#OptQuant#"/>
	...
	<td align="center"><input type="checkbox" name="POTD#Product_ID#" value="1" #doChecked(UseforPOTD)# /></td>
