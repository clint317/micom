...
<!----- TITLE ROW ------>
        <tr class="TopTierHeader">
		  ...
		  <img src="#Request.ImagePath#spacer.gif" height="2" width="1" /></td></tr>
		...
		<tr>
          <td valign="bottom">
		   ...
		   <!---- Line -------->		
			 ...
			 <img src="#Request.ImagePath#spacer.gif" height="1" width="1" /></td>
			...
			<!--- View ----->	  
			<td class="TopTierNav" nowrap="nowrap" width="5">&nbsp;</td>
			  <td class="TopTierNav"><a class="TopTierNav" href="#Request.StoreSelf#?fuseaction=product.display&product_id=#attributes.product_id##Request.Token2#" target="store">View</a></td>
			  <td class="TopTierNav" nowrap="nowrap" width="5">&nbsp;</td>						
