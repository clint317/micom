...
<cfset imgBase = GetDirectoryFromPath(ExpandPath(Request.ImagePath))>
...
<cfquery name="qry_get_images" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
...
<cfquery name="ImageSize" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
...
<cfmodule template="../../../customtags/format_output_admin.cfm"
	...
	<cfinclude template="act_images_csrfcheck.cfm">
...
<cfif imagesize.total is not ""> 
	...
	<cfoutput>Current status: <b>#qry_get_images.recordcount#</b> files
		using <b>#decimalFormat(imagesize.total/100000)#MB</b></cfoutput>
	---->	
<cfmodule template="../../../customtags/putline.cfm" linetype="thin" linecolor="#Request.GetColors.InputHBgcolor#"/>
	 ...
	 <tr>
		...
		<cf_ImageUpload
			...
			TheRecordID=			"0"
			PathToImageDir=			"#imgBase##subdir#products\"
			PathToTempDir=			"#Request.TempPath#"
			URLToImageDir=			"#Request.ImagePath##subdir#products/"
