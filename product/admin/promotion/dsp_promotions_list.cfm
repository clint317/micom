...
<!--- Displays the list of promotions. Called by product.admin&promotion=list --->

<!--- Create the string with the filter parameters --->	
<cfset fieldlist="promotion,name,coup_code,accesskey,promo_display,current">
...
<cfmodule template="../../../customtags/pagethru.cfm" 
	totalrecords="#qry_get_promotions.recordcount#" 
...
<table width="100%" cellspacing="4" border="0" cellpadding="0" class="formtext" style="color: ###Request.GetColors.OutputTText#;">	
	...
	<tr>
		<td colspan="4">
			<a href="#self#?fuseaction=product.admin&promotion=add#Request.Token2#">New Promotion</a></td>
		<td colspan="4"
	...
	<tr>
		...
		<td><span class="formtextsmall">display<br/></span>
			<input type="text" name="promo_display" size="20" maxlength="25" class="formfield" value="#attributes.promo_display#"/></td>				
		...
		<td><br/><a href="#self#?fuseaction=product.admin&promotion=list#Request.Token2#">ALL</a><br/>
		</td></tr>
		</form>
...
<cfif qry_get_promotions.recordcount gt 0>					
	<cfloop query="qry_get_promotions" startrow="#PT_StartRow#" endrow="#PT_EndRow#">
		<tr>
			<td><a href="#self#?fuseaction=product.admin&promotion=edit&promotion_id=#promotion_ID##Request.Token2#">
			Edit #promotion_ID#</a></td>		
