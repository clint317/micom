...
<cfswitch expression="#promotion#">
	...
	<cfcase value="edit">
		...
		<cfloop list="#fieldlist#" index="counter">
			<cfset attributes[counter] = qry_get_promotion[counter][1]>
		</cfloop>
...
<cfoutput>
	...
	<!--- Display --->
		<tr>
			...
			<td style="background-color: ###Request.GetColors.formreq#;"></td>
		 	<td>
			<input type="text" name="Promo_Display" value="#attributes.Display#" size="40" maxlength="255" class="formfield"/>
			</td></tr>			
	...
	<!--- Coupon Code --->
		<tr>
			...
			<br/><span class="formtextsmall">Customer must enter this code to receive the promotion (codes are case-insensitive).</span>
			</td></tr>		
...
objForm.required("Type1,Type4,Type3,Name,Promo_Display,QualifyNum,DiscountNum,Multiply,OneTime");
...
objForm.Promo_Display.description = "display to users";
