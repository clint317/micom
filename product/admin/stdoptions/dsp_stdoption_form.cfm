...
<cfswitch expression="#stdoption#">
	...
	<cfcase value="edit">
		...
		<cfloop list="#fieldlist#" index="counter">
			<cfset attributes[counter] = qry_get_stdoption[counter][1]>
		</cfloop>
...
<cfif Number>
	...
	<cfloop query="qry_get_StdOpt_Choices">
		...
		<tr>
			<td align="left"><input type="text" name="ChoiceName#currentrow#" value="#HTMLEditFormat(qry_get_StdOpt_Choices.ChoiceName)#" size="25" maxlength="150" class="formfield"/></td>
...
<input type="hidden" name="SortOrder#currentrow#_float" value="The sort order must be a number!"/>
			<td align="center"><input type="checkbox" name="Std_Display#currentrow#" class="formfield" #doChecked(qry_get_StdOpt_Choices.Display)#/></td>
			<td align="center">
...
document.write('<td align="LEFT"><br/>\n');
	...
	document.write('<tr><td align="left"><input type="text" name="ChoiceName' + i + '" size="25" maxlength="150" class="formfield"/></td>\n');
...
document.write('<td align="center"><input type="checkbox" name="Std_Display' + i + '" class="formfield" checked="checked" /></td>\n');
