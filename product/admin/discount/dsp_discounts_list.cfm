...
<cfset fieldlist="name,coup_code,disc_display,current,accesskey">
...
<table width="100%" cellspacing="4" border="0" cellpadding="0" class="formtext" style="color: ###Request.GetColors.OutputTText#;">	
	...
	<tr>
		...
		<td><span class="formtextsmall">display<br/></span>
			<input type="text" name="disc_display" size="20" maxlength="25" class="formfield" value="#attributes.disc_display#"/></td>				
