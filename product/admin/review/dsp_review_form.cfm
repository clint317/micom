...
<cfmodule template="../../../customtags/format_admin_form.cfm"
	...
	<cfif GetDetail.recordcount>
		...
		<td></td>
		<td>
		<span class="prodname"><a href="#Request.StoreSelf#?fuseaction=product.display&product_ID=#attributes.product_ID##Request.Token2#" class="prodname_list" target="store">#GetDetail.Name#</a></span><br/>
...
<!--- anonymous --->
	...
	<tr>
	  ...
	  <td></td>
      <td>
	 	 <input type="text" name="anon_name" value="#HTMLEditFormat(attributes.anon_name)#"  class="formfield"/>
		</td>
    </tr>
    ...
    <tr>
	  ...
	  <td></td>
      <td><input type="text" name="anon_email" size="45" value="#HTMLEditFormat(attributes.anon_email)#" class="formfield"/><br/>
	  <span class="formtextsmall">(not displayed)</span>
	  </td>
    </tr>
    ...
    <tr>
	  ...
	  <td></td>
      <td><input type="text" name="Anon_Loc" size="45" value="#HTMLEditFormat(attributes.Anon_Loc)#" class="formfield"/><br/>
	...
	<tr>
      ...
      <td><input type="text" name="title" value="#HTMLEditFormat(attributes.title)#" size="60" maxlength="50" class="formfield"/></td>
    </tr>
