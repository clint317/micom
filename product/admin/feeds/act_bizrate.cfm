...
SELECT P.Product_ID, A.Account_Name AS Manufacturer, P.Name AS Title, P.Long_Desc, P.Short_Desc, P.Lg_Image, P.Sm_Image, P.SKU, P.Vendor_SKU, P.Goog_Condition, Weight, P.Base_Price AS Price, C.PassParam AS BizrateCategory
...
<cfif Not Len(Goog_Condition)>
	<cfset Goog_Condition = "New">
</cfif>

<cfif len(Category)>
	<cfset prodline = "#Category##Tab##Manufacturer##Tab##Title##Tab##Description##Tab##Request.StoreSelf#?fuseaction=product.display&product_ID=#product_ID##Tab##Image##Tab##SKU##Tab#In Stock#Tab##Goog_Condition##Tab##Weight##Tab##Tab##Tab##Tab##Tab##Price#">
