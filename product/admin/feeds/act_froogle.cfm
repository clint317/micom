...
<cfquery name="CustomFields" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
SELECT Google_Code
...
<cfloop query="qry_get_products">
	...
	<!--- Get Custom Data --->
	<cfquery name="GetCustomInfo" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
	...
	ON (PI.Custom_ID = PC.Custom_ID
		AND PI.Product_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#qry_get_products.Product_ID#">)
	...
	<cfset prodline = "#Request.StoreSelf#?fuseaction=product.display&Product_ID=#Product_ID##Tab##Name##Tab##SKU##Tab##description##Tab##prodimage##Tab##goog_brand##Tab##goog_condition##Tab##goog_prodtype##tab##DateFormat(goog_Expire, "yyyy-mm-dd")##tab##Base_Price#">
