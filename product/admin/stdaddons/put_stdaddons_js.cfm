...
<!--- This page is used to run the javascript checks for the standard addon form. Called from dsp_stdaddon_form.cfm --->
...
function CancelForm () {
	<cfoutput>location.href = "#self#?fuseaction=product.admin&stdaddon=list&redirect=yes#request.token2#";</cfoutput>
	}
