...
<cfmodule  template="../../access/secure.cfm"
	...
	>	
	<span class="menu_admin"><br/>[<a href="#XHTMLFormat('#Request.SecureSelf#?fuseaction=product.admin&do=edit&product_id=#qry_get_products.product_id##Request.AddToken#')#" #doAdmin()#>Edit Product #product_id#</a>]<br/></span>
</cfmodule>
