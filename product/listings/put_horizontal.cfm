...
<cfoutput>
<!-- start product/listings/put_horizontal.cfm -->
<div id="puthorizontal" class="product">
...
<cfif request.appsettings.productreviews>	
	...
	<cfif qry_get_products.reviewable AND not listfind(qry_get_products.passparam,'reviews=0')>	
		<cfif IsNumeric(Avg_Rating)>
			<img src="#Request.ImagePath#icons/#ceiling(Avg_Rating)#_lg_stars.gif" alt="" />
...
<!-- end product/listings/put_horizontal.cfm -->
</cfoutput>
