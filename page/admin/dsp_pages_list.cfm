...
<table width="100%" cellspacing="4" border="0" cellpadding="0" class="formtext" style="color: ###Request.GetColors.OutputTText#;">		
	...
	<tr>
		<td colspan="6" style="BACKGROUND-COLOR: ###Request.GetColors.outputHBgcolor#;"><img src="#Request.ImagePath#spacer.gif" alt="" height="1" width="1" /></td>
</tr>
		
<cfset formkey = CreateUUID()>
<cfset session.formKeys.pageList = formkey>
...
<cfif qry_get_Pages.recordcount gt 0>		
	...
	<tr>
		...
		<cfif len(Page_URL)>
			<cfset viewlink = Page_URL>
		<cfelse>
			<cfset viewlink = "#Request.StoreSelf#?fuseaction=page.display&page_id=#page_ID#">
		</cfif>
		<td><a href="#viewlink##Request.Token2#" target="store"><cfif istitle>#Page_name#</strong><cfelse>#Page_name#</cfif></a></td>
		<td <cfif system> class="caution"</cfif>>#Page_URL#</td>
		<td align="center"><cfif Display is 1 and page_id is not "0">Yes</cfif></td>
		<td><a href="#self#?fuseaction=page.admin&do=copy&Page_ID=#Page_ID#&formkey=#Hash(formkey,"SHA-256")##Request.Token2#">copy</a></td>
	</tr>	
