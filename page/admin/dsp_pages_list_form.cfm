...
<cfif qry_get_Pages.recordcount gt 0>		
	...
	<tr>
		...
		<td><a href="#Request.StoreSelf#?fuseaction=page.display&page_id=#page_ID##Request.Token2#" target="store"><cfif istitle>#Page_name#</strong><cfelse>#Page_name#</cfif></a></td>
