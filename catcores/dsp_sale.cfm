...
<!-- start catcores/dsp_sale.cfm -->
<div id="dspsale" class="catcores">
...
<cfmodule template="../access/secure.cfm"
	...
	>	
	<cfoutput><span class="menu_admin">[<a href="#XHTMLFormat('#Request.SecureSelf#?fuseaction=category.admin&category=edit&CID=#qry_get_Hcats.category_id##Request.AddToken#')#"  #doAdmin()#>EDIT CAT #qry_get_Hcats.category_id#</a>]</span></cfoutput>
</cfmodule>
