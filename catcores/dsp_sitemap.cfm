...
<!-- start catcores/dsp_sitemap.cfm -->
<div id="dspsitemap" class="catcores">
...
<cfoutput><img src="#Request.ImagePath#icons/up.gif" border="0" valign="baseline" alt="" hspace="2" vspace="0" /> <a href="#XHTMLFormat('#self##cgi.path_info##Request.Token1#')###top">top</a></cfoutput>
<p>
