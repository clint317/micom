...
<!-- start catcores/catcore_hightlight.cfm -->
<div id="catcorehighlight" class="catcores">
...
<cfmodule template="../access/secure.cfm"
	...
	>	
	<cfoutput><span class="menu_admin">[<a href="#XHTMLFormat('#Request.SecureSelf#?fuseaction=Category.admin&Category=edit&CID=#category_id##Request.AddToken#')#" #doAdmin()#>EDIT CAT #category_id#</a>]</span></cfoutput></cfmodule>
...
<cfelseif CurrentNum IS TotalNum>
	<cfloop index = "num" from="1" to="#(PColumns - CurrentNum MOD PColumns)#">
...
<cfoutput>
	<td valign="top" width="#Round(100/PColumns)#%">
...
<!-- start catcores/catcore_highlight.cfm -->
