...
<cfif not IsDefined("ThisTag.ExecutionMode")>
	...
	<!--- Blank Layouts ---->
	<cfif fusebox.targetcircuit IS "SHOPPING" and isdefined("attributes.order") AND ListFindNoCase("history,viewterms",attributes.order)>
	...
	<cfelseif fusebox.targetcircuit IS "SHOPPING" and isdefined("attributes.order") AND ListFindNoCase("print,printreport",attributes.order)>
		<cfset fusebox.layoutFile="layouts/lay_printing.cfm">
