...
<cfif attributes.submit_customer IS NOT "Add">
	<cfquery name="CheckUser" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#" maxrows="1">
			SELECT Customer_ID
			FROM #Request.DB_Prefix#Customers 
			WHERE User_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#Session.User_ID#">
			AND Customer_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.customer_ID#">
	</cfquery>
	...
	<cfif accessokay>
		...
		<cfswitch expression = "#attributes.submit_customer#">
			...
			<cfcase value="update">
				...
				<cfquery name="FindCustomer" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#" maxrows="1">
					SELECT C.*, N.Order_No
					FROM #Request.DB_Prefix#Order_No N 
					RIGHT JOIN #Request.DB_Prefix#Customers C ON N.Customer_ID = C.Customer_ID
					WHERE C.Customer_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.customer_ID#">
				</cfquery>
				...
				<cfelse>
					...
					<cfquery name="UpdateCustomer" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
						...
						SET User_ID = 0
						WHERE Customer_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#old_customer_ID#">
					</cfquery>
			...
			<cfcase value="delete">
				...
				<cfquery name="Findshipto" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#" maxrows="1">
					SELECT Order_No
					FROM #Request.DB_Prefix#Order_No 
					WHERE ShipTo = <cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.customer_id#">
				</cfquery>
		...
		<cfif attributes.mode is "customer">
			...
			<cfquery name="UpdateUser" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
				UPDATE #Request.DB_Prefix#Users
				SET Customer_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.customer_id#">, 
				ShipTo = <cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.shipto#">
				WHERE User_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#Session.User_ID#">
			</cfquery>
		...
		<cfif attributes.mode is "shipto">
			<cfquery name="UpdateUser" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
				UPDATE #Request.DB_Prefix#Users
				SET ShipTo = <cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.customer_id#">
				WHERE User_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#Session.User_ID#">
			</cfquery>
		</cfif>
