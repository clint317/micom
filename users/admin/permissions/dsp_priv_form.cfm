...
<cfhtmlhead text="
	<script type='text/javascript' src='#Request.StorePath#includes/mxAjax/core/js/prototype.js'></script>
	<script type='text/javascript' src='#Request.StorePath#includes/mxAjax/core/js/mxAjax.js'></script>
	<script type='text/javascript' src='#Request.StorePath#includes/mxAjax/core/js/mxMultiSelect.js'></script>
	<link rel='stylesheet' type='text/css' href='#Request.StorePath#css/ricostyles.css'/>
	">
<cfoutput>
