...
<!--- This page is used by discounts/promotions to add related user groups. It lists current related groups with links to edit or remove them, and allows the admin to select new groups to add as related. Called by product.admin&discount=groups --->
...
<cfset fieldlist="name,description,wholesale">
