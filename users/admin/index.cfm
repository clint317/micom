...
<cfelseif isdefined("attributes.user")>	
	...
	<cfswitch expression = "#attributes.user#">
		...
		<cfcase value="sendcode">
			<cfinclude template="user/act_send_code.cfm">
			<cfset attributes.message="New unlock code has been emailed to user">
			<cfset attributes.XFA_success="fuseaction=users.admin&user=summary&uid=#attributes.uid#">
			<cfinclude template="../../includes/admin_confirmation.cfm">			
		</cfcase>	
...
<cfelseif isdefined("attributes.email")>		
	...
	<cfswitch expression = "#attributes.email#">
		...
		<cfcase value="write">
			<cfparam name="attributes.xfa_success" default="fuseaction=users.admin&email=select">
			<cfinclude template="email/qry_getemails.cfm">
			<cfif NOT qry_GetEmails.Recordcount>
				<cfset attributes.error_message = "No matching email address(s) found.">
				<cfinclude template="../../../includes/admin_confirmation.cfm">
			<cfelse>
...
<cfelseif isdefined("attributes.mailtext")>		
	...
	<cfset Webpage_title = "System Text">
