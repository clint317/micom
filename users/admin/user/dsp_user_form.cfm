...
<cfset attributes.returntoForm = "fuseaction=users.admin&user=edit&uid=#attributes.uid#">
...
<!--- Username --->
 ...
 <!--- Password --->
			<tr>
				...
				[ <a class="formtextsmall" href="#self#?fuseaction=users.admin&user=resetpw&uid=#attributes.uid#&email=#attributes.email#&XFA_success=#URLEncodedFormat(attributes.returntoForm)#">Send New Password</a> ]</cfif>
				</td>
			</tr>
 ...
 <!--- Email --->
			<tr>
				...
				<cfif attributes.user is "edit">[ <a  class="formtextsmall" href="#self#?fuseaction=users.admin&email=write&UID=#attributes.uid#&XFA_success=#URLEncodedFormat(attributes.returntoForm)#">Send Mail</a> ]</cfif>
				</td>
			</tr>
			...
			<tr>
				...
				<td></td>
		 		<td>#attributes.EmailLock#
					...
					[ <a  class="formtextsmall" href="#self#?fuseaction=users.admin&user=unlock&uid=#attributes.uid#&formkey=#Hash(formkey,"SHA-256")#&XFA_success=#URLEncodedFormat(attributes.returntoForm)#">unlock</a> ]

					[ <a  class="formtextsmall" href="#self#?fuseaction=users.admin&email=write&uid=#attributes.uid#&MailText_ID=2&XFA_success=#URLEncodedFormat(attributes.returntoForm)#">send code</a> ]
					</cfif></td>
			</tr>
</cfif>
 	...
 	<!--- Notes --->
			...
			<tr>
				...
				<cfmodule 
					...
					toolbarSet="Basic" 
					config="#config#"
					Value="#Application.objGlobal.doImgPaths(attributes.AdminNotes)#"
					/>
			</td>
			</tr>				
 ...
 <!--- Permissions 
	...
	--->		
		...
		<cfinclude template="../../../includes/form/put_space.cfm">
			...
			<input type="button" value="Cancel" onclick="javascript:location.href='#self#?#URLEncodedFormat(attributes.XFA_success)#;" class="formbutton"/> 	
