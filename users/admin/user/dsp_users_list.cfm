...
<cfset fieldlist="user,uid,un,email,custname,email_bad,subscribe,affiliate,cid,gid,account_id,birthdate,CardisValid,cardnumber,show">
...
<cfoutput>	
<table width="100%" cellspacing="2" border="0" cellpadding="0" class="formtext" style="color: ###Request.GetColors.OutputTText#;">		
...
<form action="#self#?fuseaction=users.admin&user=list#request.token2#" method="post">
		...
		<td><span class="formtextsmall">email<br/></span>
			<input type="text" name="email" size="13" maxlength="25" class="formfield" value="#attributes.email#"/>
		...
		<td>
			<span class="formtextsmall">real name</span><br/>
			<input type="text" name="Custname" size="12" maxlength="50" value="#attributes.Custname#" class="formfield"/>
			</td>
