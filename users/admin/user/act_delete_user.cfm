...
<!--- Check for Account --->
<cfquery name="GetAccount"  datasource="#Request.ds#" username="#Request.DSuser#" password="#Request.DSpass#">
...
<cfif GetCustomers.RecordCount>
	...
	<cfset CustList = ValueList(GetCustomers.Customer_ID)>
		...
		<cfquery name="checkorders" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
			...
			WHERE Customer_ID IN (<cfqueryparam cfsqltype="cf_sql_integer" value="#CustList#" list="true">) 
			OR ShipTo IN (<cfqueryparam cfsqltype="cf_sql_integer" value="#CustList#" list="true">)
		</cfquery>
...
<cfif NOT len(attributes.error_message)>
	...
	<cfquery name="check_helpful"  datasource="#Request.ds#" username="#Request.DSuser#" password="#Request.DSpass#">
		SELECT Review_ID, Helpful FROM #Request.DB_Prefix#ProductReviewsHelpful
		WHERE User_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.UID#">
	</cfquery>
	
	<cfloop query="check_helpful">
		<cfquery name="Upd_review"  datasource="#Request.ds#" username="#Request.DSuser#" password="#Request.DSpass#">
			...
			WHERE Review_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#check_helpful.Review_ID#">
		</cfquery>
	</cfloop>

	<!--- Now remove the helpful votes --->
	<cfquery name="delete_helpful_votes"  datasource="#Request.ds#" username="#Request.DSuser#" password="#Request.DSpass#">
	...
	<cfquery name="delete_productreviews"  datasource="#Request.ds#" username="#Request.DSuser#" password="#Request.DSpass#">
		DELETE FROM #Request.DB_Prefix#ProductReviews
		WHERE User_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.UID#">
	</cfquery>			

	<!--- Remove user id on any article comments --->
	<cfquery name="delete_FeatureReviews"  datasource="#Request.ds#" username="#Request.DSuser#" password="#Request.DSpass#">
	...
	<cfquery name="delete_WishList"  datasource="#Request.ds#" username="#Request.DSuser#" password="#Request.DSpass#">
		DELETE FROM #Request.DB_Prefix#WishList 
		WHERE User_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.UID#">
	</cfquery>
		
	<cfquery name="delete_Memberships"  datasource="#Request.ds#" username="#Request.DSuser#" password="#Request.DSpass#">
		DELETE FROM #Request.DB_Prefix#Memberships 
		WHERE User_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.UID#">
	</cfquery>
	
	<cfquery name="delete_users"  datasource="#Request.ds#" username="#Request.DSuser#" password="#Request.DSpass#">
...
<cfelse>
	...
	<cfset attributes.error_message = "User #Val(attributes.UID)# could not be deleted for the following reasons:<br/>" &  attributes.error_message >
