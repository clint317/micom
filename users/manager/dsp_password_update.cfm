...
<!-- start users/manager/dsp_password_update.cfm -->
<div id="dsppasswordupdate" class="users">
...
<tr><td colspan="3"><img src="#Request.ImagePath#spacer.gif" height="3" width="1" alt="" /></td></tr>
...
<!-- end users/manager/dsp_password_update.cfm -->
