...
<cfhtmlhead text="
<!-- start code added by users/manager/dsp_addressbook.cfm -->
...
<!-- end code added by users/manager/dsp_addressbook.cfm -->
">

<!-- start users/manager/dsp_addressbook.cfm -->
<div id="dspaddressbook" class="users">

<cfif qry_get_addressbook.recordcount>
	<cfoutput>
	<form action="#XHTMLFormat('#request.self#?#attributes.xfa_submit_addressbook##request.token2#')#" name="addressbook" method="post">
...
<cfelse><!--- no addresses found --->
	<tr>
   		<td colspan="2" align="center">		
			...
			<cfoutput>
			<form action="#XHTMLFormat('#self#?fuseaction=users.manager#request.token2#')#" method="post" name="back" id="back" class="margins">
			</cfoutput>
...
<!-- end users/manager/dsp_addressbook.cfm -->
