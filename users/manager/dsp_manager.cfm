...
<!-- start users/manager/dsp_manager.cfm -->
<div id="dspmanager" class="users">
...
<cfmodule template="../../access/secure.cfm"
	...
	<li><a href="#XHTMLFormat('#Request.SecureSelf#?fuseaction=home.admin#Request.AddToken#')#" target="admin"><b>Admin</b></a> - Access the backend store administration section.
	<br/><br/></li>
	</cfmodule>	

	<li> <a href="#XHTMLFormat('#Request.Storeself#?fuseaction=shopping.history#Request.Token2#')#"><b>Order History</b></a> - View and check the status of your orders.<br/><br/></li>
	...
	<li> <a href="#XHTMLFormat('#Request.Storeself#?fuseaction=shopping.affiliate&do=report#Request.Token2#')#"><b>Affiliate Center</b></a> - View your affiliate information and reports.<br/><br/></li>
 
 	<cfelseif get_User_Settings.AllowAffs>
  	<li> <a href="#XHTMLFormat('#Request.Storeself#?fuseaction=shopping.affiliate&do=register#Request.Token2#')#"><b>Web Affiliate Signup</b></a> - 
Start earning money today by becoming an affiliate for our store. Simply create links from your site to our homepage, category or product pages, and you will receive a percentage of each order that is filled! It's free and it's easy, so sign-up right now!<br/><br/></li>
	...
	<li> <a href="#XHTMLFormat('#Request.Storeself#?fuseaction=shopping.wishlist#Request.Token2#')#"><b>WishList</b></a> - View your personal shopping/wish list.<br/><br/></li>
	</cfif>
	
	<cfif Request.AppSettings.GiftRegistry>
	<li> <a href="#XHTMLFormat('#Request.Storeself#?fuseaction=shopping.giftregistry#Request.Token2#')#"><b>Gift Registries</b></a> - View, edit and create gift registries accessible to others. <br/><br/></li>
	</cfif>
   
  	<li> <a href="#XHTMLFormat('#Request.Storeself#?fuseaction=access.memberships#Request.Token2#')#"><b>Site Access</b></a> - A list of your current memberships and purchased downloads.<br/><br/></li>

  	<li> <a href="#XHTMLFormat('#Request.Storeself#?fuseaction=access.download#Request.Token2#')#"><b>File Downloads</b></a> - Download purchased products here.<br/><br/></li>
<cfif request.appsettings.ProductReviews>
  	<li> <a href="#XHTMLFormat('#Request.Storeself#?fuseaction=product.reviews&do=manager#Request.Token2#')#"><b>My Reviews</b></a> - View and edit my product reviews.<br/><br/></li>
		...
		<blockquote>You must confirm your email address.<br/><br/>
				<li><a href="#XHTMLFormat('#self#?fuseaction=users.unlock&#request.token2#')#">Click Here To Confirm Your Email Address.</a><br/><br/></li>
		</blockquote>
		</cfif>	
</cfif>	

	<!---The "Login as Another User" links --->
	<cfif isdefined("Session.AnotherUserLogin")>
		<li><a href="#Request.SecureSelf#?fuseaction=users.loginAsAnother#Request.AddToken#"><b>Login as Another User</b></a> - Select another user to place order for. <br/><br/></li>
	<cfelse>
		<!--- Users Permission 2 = User Admin Functions --->   
		<cfmodule template="../../access/secure.cfm"
		keyname="shopping"
		requiredPermission="1024">
			<li><a href="#Request.SecureSelf#?fuseaction=users.loginAsAnother#Request.AddToken#"><b>Login as Another User</b></a> - Switch to another account, to placer orders for that user.<br/><br/></li>
		</cfmodule>
	</cfif>
...
<!-- end users/manager/dsp_manager.cfm -->
