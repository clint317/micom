...
<cfif attributes.submit_login is "login">
	...
	<cfif qry_get_user.RecordCount>
		...
		<cfelseif Compare(qry_get_user.Password, Hash(attributes.Password)) IS 0 
			...
			<cfquery name="lastlogin" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
			...
			<cfif errormess IS 0>
				...
				<cfquery name="AddBasket" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
					UPDATE #Request.DB_Prefix#Users 
	...
	window.location = '#Request.SecureSelf#?fuseaction=users.email&redirect=1#Request.AddToken#';
	</script>
					">		
				</cfif>
	...
	window.location = '#Request.SecureSelf#?fuseaction=users.ccard&redirect=1#Request.AddToken#';
	</script>			
					">
				</cfif>
	...
	<cfelse>
		<cfset errormess = 1>
		<cfinclude template="dsp_result.cfm">
		<cfquery name="failedlogin" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
			UPDATE #Request.DB_Prefix#Users 
