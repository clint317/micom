...
<cfif len(qry_get_user.NameonCard) and len(qry_get_user.CardNumber) and isDate(qry_get_user.cardexpire)>
	...
	<cfelseif get_Order_Settings.CCProcess IS "AuthorizeNet3">
		...
		<cfmodule template="../shopping/checkout/creditcards/authorizenet/authorizenet30.cfm"
		QUERYNAME="Results"
		...
		<cfelse>
			<cfset adminnote = "#dateformat(now(),"mm/dd/yy")#: card NOT authorized #Results.response_code# #Results.reason_text#. ">
		</cfif>
	...
	<cfelseif get_Order_Settings.CCProcess IS "Shift4OTN">
		...
		<!--- get token request --->
		<cfmodule
			template="../shopping/checkout/creditcards/shift4/shift4otn.cfm"
			Result="OTN"
		...
		<cfif OTN.ErrorIndicator is "Y">
			<cfset adminnote = "#dateformat(now(),"mm/dd/yy")#: card NOT tokenized - #OTN.LongError# (#OTN.PrimaryErrorCode#)">
