...
<!-- start users/manager/dsp_customer_form.cfm -->
<div id="dspcustomerform" class="users">
...
width="380">
	...
	<tr>
		<td colspan="3" align="center" class="formerror"><br/>#HTMLEditFormat(attributes.Message)#<br/><br/></td></tr>
	</cfif>				
...
<!-- end users/manager/dsp_customer_form.cfm -->
