...
>	
<cfoutput>| <a href="#XHTMLFormat('#Request.SecureSelf#?fuseaction=category.admin&category=edit&CID=#request.qry_get_cat.category_id##Request.AddToken#')#"  #doAdmin()#>EDIT CATEGORY #request.qry_get_cat.category_id#</a> | <a href="#XHTMLFormat('#Request.SecureSelf#?fuseaction=category.admin&category=add&PID=#request.qry_get_cat.category_id##Request.AddToken#')#" #doAdmin()#>ADD SUB-CAT</a>
| <a href="#XHTMLFormat('#Request.SecureSelf#?fuseaction=category.admin&category=listform&PID=#request.qry_get_cat.category_id##Request.AddToken#')#" #doAdmin()#>EDIT SUB-CAT LIST</a> 
</cfoutput>
</cfmodule>
...
<cfmodule template="../access/secure.cfm"
	...
	requiredPermission="1"
	>
<cfif qry_get_catCore.products is 1><cfoutput> | <a href="#XHTMLFormat('#Request.SecureSelf#?fuseaction=product.admin&do=add&cid=#request.qry_get_cat.category_id##Request.AddToken#')#" #doAdmin()#>ADD PRODUCT</a> | <a href="#XHTMLFormat('#Request.SecureSelf#?fuseaction=product.admin&do=listform&cid=#request.qry_get_cat.category_id#&Parent_ID=0#Request.AddToken#')#" #doAdmin()#>EDIT PRODUCT LIST</a>
</cfoutput>
</cfif> 
</cfmodule>
...
<cfif qry_get_catCore.features is 1>
	...
	><br/>
	<cfoutput> | <a href="#XHTMLFormat('#Request.SecureSelf#?fuseaction=feature.admin&feature=add&CID=#request.qry_get_cat.category_id##Request.AddToken#')#" #doAdmin()#>ADD FEATURE</a> </cfoutput>
	</cfmodule>
	...
	>
	<cfoutput> | <a href="#XHTMLFormat('#Request.SecureSelf#?fuseaction=feature.admin&feature=listform&CID=#request.qry_get_cat.category_id##Request.AddToken#')#"  #doAdmin()#>EDIT FEATURE LIST</a> |</cfoutput>
	</cfmodule>
</cfif>
