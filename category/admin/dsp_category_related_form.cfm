...
<cfset session.formKeys.relatedCategories = formkey>
...
<table width="90%" cellspacing="4" border="0" cellpadding="0" class="formtext"style="color:###Request.GetColors.InputTText#">	
	...
	<tr>
		...
		<td>[<a href="#self#?#addedpath#&submit_related=#category_id#&formkey=#Hash(formkey,"SHA-256")##Request.Token2#">remove</a>]
