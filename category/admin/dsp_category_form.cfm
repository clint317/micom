...
<cfswitch expression="#category#">
	...
	<cfcase value="edit">
		...
		<cfloop list="#fieldlist#" index="counter">
			<cfset attributes[counter] = qry_get_category[counter][1]>
		</cfloop>
...
<cfoutput>
	<form name="editform" action="#action##request.token2#" id="editform" method="post">
...
<!--- Parent ID --->
 ...
 <!--- Display --->
			<tr>
				...
				<td></td>
				<td><input type="radio" name="Cat_Display" value="1" #doChecked(attributes.Display)# /> Yes  
				&nbsp;&nbsp;<input type="radio" name="Cat_Display" value="0" #doChecked(attributes.Display,0)# /> No<br/>
...
<!--- Line --->
 ...
 <!--- Parameters --->
			<tr>
				...
				<td></td>
		 <td>
			<input type="text" name="Passparam" class="formfield" value="#attributes.Passparam#" size="75" maxlength="100"/>
...
<input type="hidden" name="CurrDiscounts" value="#CurrDiscounts#"/>
 ...
 <!--- Category Columns --->
		 ...
		 <td>
			...
			<input type="text" name="PColumns" message=""  value="#attributes.PColumns#" size="3" maxlength="10" class="formfield"/> Content
			</td>
			</tr>
...
<!--- Custom palette --->
			<tr>
				...
				<td></td>
		 		<td>
				<select name="cat_color_id" size="1"  class="formfield">
...
objForm.required("Name,Catcore_ID");
