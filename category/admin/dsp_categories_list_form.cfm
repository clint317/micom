...
<cfset fieldlist="category,pid,cid,catcore_id,name,accesskey,catdisplay,highlight,sale">
...
<cfoutput>	
	...
	<tr>
		...
		<select name="catdisplay" class="formfield">
			<option value="">all</option>
			<option value="0" #doSelected(attributes.catdisplay,0)#>no</option>
			<option value="1" #doSelected(attributes.catdisplay,1)#>yes</option>
		</select></td>	
		...
		<tr>
			<td colspan="9" style="BACKGROUND-COLOR: ###Request.GetColors.inputHBgcolor#;"><img src="#Request.ImagePath#spacer.gif" alt="" height="1" width="1" /></td>
		</tr>
	<tr>
		<th>Edit</th>
		<th>Category</th>
...
<td align="center"><input type="checkbox" name="CatDisplay#Category_ID#" value="1" #doChecked(Display)#/></td>
...
<td align="center"><input type="checkbox" name="Sale#Category_ID#" value="1" #doChecked(Sale)#/></td>
			...
			<a href="#Request.StoreSelf#?fuseaction=category.display&category_id=#Category_ID##Request.Token2#" target="store">view</a>
			</td>
		</tr>
		</cfloop>	
	<tr>
