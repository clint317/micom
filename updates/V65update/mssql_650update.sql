...
CREATE TABLE Payments (
    ...
    Order_No         int              NULL,
    InvoiceNum       nvarchar(20)     NOT NULL,
    ...
    CONSTRAINT Payments_PK PRIMARY KEY NONCLUSTERED ([PaymentID])
);

CREATE  INDEX "Payments_BasketNum_Idx" ON "Payments" ("BasketNum")
CREATE  INDEX "Payments_ID_Tag_Idx" ON "Payments" ("ID_Tag")
CREATE  INDEX "Payments_Order_No_Idx" ON "Payments" ("Order_No")
CREATE  INDEX "Payments_Captured_Idx" ON "Payments" ("Captured")
	;


ALTER TABLE Order_No ADD TermsUsed NTEXT NULL;
ALTER TABLE Order_No ADD OriginalTotal float NOT NULL DEFAULT (0);
ALTER TABLE Order_No ADD LastTransactNum varchar(50) NULL;
...
ALTER TABLE OrderSettings ADD UseCRESecure bit NOT NULL DEFAULT 0;
...
INSERT INTO CCProcess
	(Transtype,Username,Password,Setting1,Setting2,Setting3)
	VALUES ('Sale', NULL, NULL, NULL, NULL, 'PayPalExpress');
...
UPDATE USPSMethods SET Code = 'Global Express Guaranteed (GXG)' WHERE Code = 'Global Express Guaranteed';
UPDATE USPSMethods SET Code = 'Express Mail International' WHERE Code = 'Express Mail International (EMS)';
UPDATE USPSMethods SET Code = 'First-Class Mail International Package' WHERE Code = 'First-Class Mail International';

INSERT INTO USPSMethods (Name, Used, Code, Type, Priority)
VALUES ('Express Mail Sunday/Holiday Delivery',0,'Express Mail Sunday/Holiday Delivery','Domestic',2);
...
INSERT INTO Countries (Abbrev, Name, AllowUPS, Shipping, AddShipAmount) 
VALUES ( 'VG', 'Tortola', 1, 0, 0);
INSERT INTO Countries (Abbrev, Name, AllowUPS, Shipping, AddShipAmount) 
VALUES ( 'UI', 'Union Island', 1, 0, 0);
INSERT INTO Countries (Abbrev, Name, AllowUPS, Shipping, AddShipAmount) 
VALUES ( 'CS', 'Serbia and Montenegro', 1, 0, 0);
INSERT INTO Countries (Abbrev, Name, AllowUPS, Shipping, AddShipAmount) 
...
DELETE FROM Countries WHERE Abbrev = 'VG';
