...
ALTER TABLE FedEx_Settings ADD UserKey varchar (75);
ALTER TABLE FedEx_Settings ADD Password varchar (75);
ALTER TABLE FedEx_Settings ADD AddInsurance bit NOT NULL DEFAULT 0;
