...
<cfquery name="ProdDiscounts" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
...
<cfloop query="ProdDiscounts">
	<cfloop index="ProdID" list="#ProdDiscounts.Products#">
		<cfquery name="AddProd" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
...
<cfquery name="CatDiscounts" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
...
<cfloop query="CatDiscounts">
	...
	<cfloop index="CatID" list="#CatList#">
		<cfquery name="AddCategory" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
...
<cfquery name="UpdCatDiscounts" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
UPDATE Discounts
SET Type3 = 1 
WHERE Type3 = 2
</cfquery>
...
<cfquery name="GroupDiscounts" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
...
<cfquery name="GetProds" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
...
<cfloop query="GetProds">
	...
	<cfquery name="UpdDiscList" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
	UPDATE Products
