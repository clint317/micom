...
<cfquery name="GetPaymentSettings" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#" maxrows="1">
...
<cfquery name="Update1" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
	UPDATE OrderSettings SET
	CCProcess = 'PayFlowPro'
	WHERE CCProcess = 'PaymentNet'
</cfquery>

<cfquery name="Update2" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
	UPDATE OrderSettings SET
...
<cfquery name="UserSettings" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
...
<cfquery name="OrphanWishListProds" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
...
<cfset attributes.Page_ID = attributes.Page_ID + 1>
	<cfquery name="Add_Record2" datasource="#Request.ds#" username="#Request.DSuser#"  password="#Request.DSpass#">
	INSERT INTO #Request.DB_Prefix#Pages
		(Page_ID, Page_URL, CatCore_ID, PassParam, Display, PageAction, Page_Name, Page_Title, Sm_Image,
		Lg_Image, Sm_Title, Lg_Title, Color_ID, PageText, System, Href_Attributes, AccessKey, Priority, 
		Parent_ID, Title_Priority, Metadescription, Keywords,TitleTag )
...
<cfset attributes.Page_ID = attributes.Page_ID + 1>
	<cfquery name="Add_Record3" datasource="#Request.ds#" username="#Request.DSuser#"  password="#Request.DSpass#">
	INSERT INTO #Request.DB_Prefix#Pages
		(Page_ID, Page_URL, CatCore_ID, PassParam, Display, PageAction, Page_Name, Page_Title, Sm_Image,
		Lg_Image, Sm_Title, Lg_Title, Color_ID, PageText, System, Href_Attributes, AccessKey, Priority, 
		Parent_ID, Title_Priority, Metadescription, Keywords,TitleTag )
...
<cfquery name="UpdSyste" datasource="#Request.ds#" username="#Request.DSuser#"  password="#Request.DSpass#">
UPDATE Pages 
SET System = 0
...
<cfquery name="ProdTaxes" datasource="#Request.ds#" username="#Request.DSuser#"  password="#Request.DSpass#">
UPDATE Products 
SET TaxCodes = 1
WHERE Tax <> 0
</cfquery>
...
<!--- Move State Taxes --->
<cfquery name="GetStateTaxes" datasource="#Request.ds#" username="#Request.DSuser#"  password="#Request.DSpass#">
SELECT * FROM Taxes
</cfquery>

<cfloop query="GetStateTaxes">
	<cfquery name="AddStateTaxes" datasource="#Request.ds#" username="#Request.DSuser#"  password="#Request.DSpass#">
...
<cfif ListGetAt(ShipSettings.BaseTax, 1) IS NOT 0>
	<cfquery name="GetCountryID" datasource="#Request.ds#" username="#Request.DSuser#"  password="#Request.DSpass#">
	SELECT ID FROM Countries
	WHERE Abbrev = '#ListGetAt(Request.AppSettings.HomeCountry, 1, "^")#'
	</cfquery>

	<cfquery name="AddCountryTax" datasource="#Request.ds#" username="#Request.DSuser#"  password="#Request.DSpass#">
...
<cfloop query="GetOrders">
	...
	<cfquery name="AddOrderTax" datasource="#Request.ds#" username="#Request.DSuser#"  password="#Request.DSpass#">
...
<cfloop index="num" from="1" to="6">
	<cfif Len(Evaluate("GetCustom.Custom#num#_Name")) AND Evaluate("GetCustom.Custom#num#_Use")>
		<cfquery name="AddCustomField" datasource="#Request.ds#" username="#Request.DSuser#"  password="#Request.DSpass#">
...
<cfquery name="GetProdCustom" datasource="#Request.ds#" username="#Request.DSuser#"  password="#Request.DSpass#">
...
<cfloop query="GetProdCustom">
	<cfloop index="num" from="1" to="6">
		<cfif Len(Evaluate("GetProdCustom.Custom#num#")) AND ListFind(CustomIDList,num)>
			<cfquery name="AddCustomInfo" datasource="#Request.ds#" username="#Request.DSuser#"  password="#Request.DSpass#">
			INSERT INTO Prod_CustInfo
			(Product_ID, Custom_ID, CustomInfo)
			VALUES
			(#GetProdCustom.Product_ID#, #num#, <cfqueryparam cfsqltype="cf_sql_varchar" value="#GetProdCustom['Custom' & num][CurrentRow]#">)
			</cfquery>
		</cfif>
	</cfloop>
</cfloop>
...
<cfloop query="GetOrders">
	...
	<cfquery name="AddItems" datasource="#Request.ds#" username="#Request.DSuser#"  password="#Request.DSpass#">
...
<cfif NOT ListFind('UPS,FedEx,USPS,Intershipper',ShipSettings.ShipType)>
	...
	<cfquery name="UpdateMethods" datasource="#Request.ds#" username="#Request.DSuser#"  password="#Request.DSpass#">
	...
	<cfloop query="GetMethods">
		<cfquery name="AddMethods" datasource="#Request.ds#" username="#Request.DSuser#"  password="#Request.DSpass#">
...
<cfif ShipSettings.ShipType IS 'UPS'>
	...
	<cfloop query="GetMethods">
		<cfquery name="UpdMethods" datasource="#Request.ds#" username="#Request.DSuser#"  password="#Request.DSpass#">
			UPDATE UPSMethods
			SET Used = 1
	...
	<cfquery name="SetOrigin" datasource="#Request.ds#" username="#Request.DSuser#"  password="#Request.DSpass#">
	UPDATE UPS_Settings
...
<cfif ShipSettings.ShipType IS 'USPS'>
	...
	<cfquery name="GetUSPS" datasource="#Request.ds#" username="#Request.DSuser#"  password="#Request.DSpass#">
		SELECT * FROM USPS
	</cfquery>
