...
<!--- If using MS-SQL, add a view with the list of defaults --->
	<cfquery name="AddView" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
	...
	<cfquery name="FindConstraint" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
	...
	<cfquery name="DropConstraint" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
	...
	<cfquery name="DropView" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
...
<cfquery name="Deletions" datasource="#Request.DS#" username="#Request.DSuser#" password="#Request.DSpass#">
