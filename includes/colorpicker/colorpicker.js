// From the tutorial at: http://www.webreference.com/programming/javascript/mk/column3/index.html


(function colorPickerNamespace(){
	var cp = null;

	var imgBase = 'includes/colorpicker/';
			...
			['DIV', {style:'position:absolute;font-family:tahoma,verdana,sans-serif;font-size:10px;', ref:'ColorPicker'},
				['DIV', {style:'background-color:#FFF;line-height:2px;width:423px;_width:424px;height:21px;border:1px solid #000;', ref:'hColorPicker'},
					...
					['DIV', {style:'float:left;'},
						...
						['IMG', {style:'cursor:pointer;margin-left:1px;display:inline;', src:imgBase+'cp_mini_icon.png', width:21, height:21, ref:'hColorIcon', onmousedown:showLgColorPicker}]
					]
				],
	...
	function hColorPickerMouseDown(){
		...
		cp.cpInput.value = cp.cpColor.toUpperCase();
		changeColorSwatch(cp.cpInput.name,cp.cpColor);
		hideColorPicker();
	}
