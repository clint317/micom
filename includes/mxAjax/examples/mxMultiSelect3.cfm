...
<html>
		...
		<script language="javascript">
			...
			function init() {
				mySelectObj = new mxAjax.MultiSelect({
					...
					selectAllActionControl: "tg1",
					clearAllActionControl: "tg2"
				});
			}
	...
	<body>
		...
		<h1>MultiSelect with custom label</h1>
		<br/>
		<form method="post" action="mxMultiSelect1.cfm">
			<div id="mySelectControl">
				<a href="javascript:void(0)" id="tg1">All</a>
				&nbsp;&nbsp;
				<a href="javascript:void(0)" id="tg2">Clear</a>
			</div>
