...
<html>
	<head>
		<title>Portlet - getting multiple CF return data</title>
	...
	<body>
		...
		<h3>Portlet - getting multiple CF return data</h3>
		<div id="portletArea">
		...
		<script type="text/javascript">
			...
			var aj_portlet_1 = new mxAjax.Portlet({
				executeOnLoad: true,
				paramArgs: new mxAjax.Param(url,{param:"make=Nokia", cffunction:"makeAndDescription"}),
