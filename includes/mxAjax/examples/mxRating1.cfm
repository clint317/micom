	...
	<head>
		...
		<style type="text/css">
			...
			div.star-rating a {
			  	...
			  	height: 30px;
			  	padding: 0 1px;
			  	background-image: url(../core/images/star/star_1_unselected.gif);
			  	background-repeat: no-repeat;
			  	background-position: 1px 0;
			}
			
			div.star-rating a.over {
			  	background-image: url(../core/images/star/star_1_hover.gif);
			}
			
			div.star-rating a.selected {
			  	background-image: url(../core/images/star/star_1_selected.gif);
			}
			...
			div.star-rating a.defaultSelected {
				background-image: url(../core/images/star/star_1_defaultselected.gif);
			}
		...
		<body>
			...
			<input type="hidden" id="raterField" />
	  		<div id="rater1" class="star-rating"><a href="javascript:void(0)" title="One"></a><a href="javascript:void(0)" title="Two"></a><a href="javascript:void(0)" title="Three"></a><a href="javascript:void(0)" title="Four"></a><a href="javascript:void(0)" title="Five"></a></div>
	  		<br/><br/><br/><br/>
