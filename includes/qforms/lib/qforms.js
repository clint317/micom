...
function _q_addField(field){
	...
	if( (!!o.type) && (typeof this[field] == "undefined") && (field.length > 0) ){
		this[field] = new qField(o, field, this._name);
...
/******************************************************************************
 qField Object
******************************************************************************/
// define qField object
function qField(form, field, formName, init){
...
new qField(null, null, null, true);
...
qField.prototype.allowFocus = _f_allowFocus;

// define qForm onFocus(); prototype
qField.prototype.onFocus = new Function("");
...
qField.prototype.addEvent = _f_addEvent;
...
qField.prototype.disabled = _f_disabled;
...
qField.prototype.checkIfLocked = _f_checkIfLocked;
...
qField.prototype.isLocked = _f_isLocked;
...
qField.prototype.getValue = _f_getValue;
...
qField.prototype.setValue = _f_setValue;

// define Field onSetValue(); prototype
qField.prototype.onSetValue = new Function("");
...
qField.prototype.triggerEvent = _f_triggerEvent;
...
qField.prototype.validateExp = _f_validateExp;
...
function _addValidator(name, fn, alwaysRun){
	...
	*/
	...
	eval("qField.prototype.is" + name + " = " + strNewFN);
	...
	eval("qField.prototype.validate" + name + " = " + strRuleFN);
...
qField.prototype.checkForErrors = _f_checkForErrors;
...
qField.prototype.throwError = _f_throwError;
