...
<!-- start search/dsp_verity_results.cfm -->
<div id="dspverityresults" class="search">
...
<!--- PageThru --->	
	...
	<!--- LINE --->	
	<tr><td colspan="2">
	<img src="#Request.ImagePath#spacer.gif" height="6" width="1" border="0" alt="" hspace="0" vspace="0" />
	</td></tr>
<!--- LINE --->	
	<tr><td colspan="2" bgcolor="###Request.GetColors.linecolor#">
	<img src="#Request.ImagePath#spacer.gif" height="1" width="1" border="0" alt="" hspace="0" vspace="0" />
	</td></tr>
...
<cfset Myval = NumberFormat((Myval * 100),'___')  "%">
...
<!--- LINE --->	
	<tr><td colspan="2">
	<img src="#Request.ImagePath#spacer.gif" height="7" width="1" border="0" alt="" hspace="0" vspace="0" />
	</td></tr>	
<!--- LINE --->	
	<tr><td colspan="2" bgcolor="###Request.GetColors.linecolor#">
	<img src="#Request.ImagePath#spacer.gif" height="1" width="1" border="0" alt="" hspace="0" vspace="0" />
