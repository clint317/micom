...
<cfif isDefined("attributes.email_submit")>
<!--- process the form --->
<!--- CSRF Check --->
<cfset keyname = "contactUsAttachForm">
...
<cfif len(trim(attributes.emailer_attachment)) AND attributes.error_message is "">
	...
	<cftry>
		...
		<cfif NOT ListFind(allowextensions,File.serverFileExt) OR Find(File.ServerFile, ";")>
...
<!-- start email/catcore_contactus_attachment.cfm -->
<div id="catcorecontactusattachment" class="email">	
...
<cfelse><!--- display the form --->
	...
	<tr>
		<td colspan="3"><img src="#Request.ImagePath#spacer.gif" alt="" height="5" width="1" /></td>
	</tr>
     <tr align="left">
...
<!-- end email/catcore_contactus_attachment.cfm -->
