...
<!-- start email/catcore_contactus.cfm -->
<div id="catcorecontactus" class="email">	
...
<cfinclude template="../includes/cffp/cfformprotect/cffp.cfm">
	<tr>
		<td colspan="3"><img src="#Request.ImagePath#spacer.gif" alt="" height="5" width="1" /></td></tr>
     <tr align="left">
...
<!-- end email/catcore_contactus.cfm -->
