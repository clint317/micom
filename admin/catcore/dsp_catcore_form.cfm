...
<cfswitch expression="#attributes.CatCore#">
	...
	<cfcase value="edit">
		...
		<cfloop list="#fieldlist#" index="counter">
			<cfset attributes[counter] = qry_get_catcore[counter][1]>
		</cfloop>
...
<cfoutput>
	...
	<!--- CatCore ID --->
			...
			<td><img src="#Request.ImagePath#spacer.gif" alt="" height="1" width="4" /></td>
	...
	<!--- Name --->
			...
			<td><input type="text" name="catcore_name" value="#attributes.catcore_name#" size="40" maxlength="50" class="formfield"/></td>
			</tr>		
	...
	<!--- Parameters --->
			...
			<td></td>
			<td><input type="text" name="passparams" value="#attributes.passparams#" size="40" maxlength="200" class="formfield"/>
			<br/><span class="formfieldsmall">List of parameters that this template accepts, if any.</span>
			</td>
			</tr>
