...
<!--- CSRF Error --->
<cfelseif isdefined("attributes.csrferror")>
	<blockquote><br> Sorry, this form does not appear to have been properly submitted. <br><br>Be sure that you reload the initial form before resubmitting it.</blockquote>
	<cfabort>
