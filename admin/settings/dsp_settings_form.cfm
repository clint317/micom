...
<input type="text" name="SiteLogo" value="#Request.AppSettings.SiteLogo#" size="30" maxlength="100" class="formfield"/> <a href="JavaScript: newWindow = openWin('#self#?fuseaction=home.admin&select=image&fieldname=SiteLogo&fieldvalue=#Request.AppSettings.SiteLogo##Request.Token2#', 'images', 'width=850,height=700,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=0,resizable=1'); newWindow.focus()" class="formtextsmall">Image Manager</a> </td></tr>
...
<tr><td colspan="2"></td><td valign="top"><span class="formtextsmall">
Setting this to "No" will hide products that are out of stock.</span>
</td></tr>
...
<tr><td colspan="2"></td><td valign="top"><span class="formtextsmall">
Retail prices are used to compare prices at "other" stores to your store prices.</span>
</td></tr>
...
<input type="text" name="OrderButtonImage" value="#Request.AppSettings.OrderButtonImage#" size="30" maxlength="100" class="formfield"/> <a href="JavaScript: newWindow = openWin('#self#?fuseaction=home.admin&select=image&fieldname=OrderButtonImage&fieldvalue=#Request.AppSettings.OrderButtonImage#', 'images', 'width=850,height=700,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=0,resizable=1'); newWindow.focus()" class="formtextsmall">Image Manager</a> </td></tr>
</CFIF>
...
<input type="hidden" name="UseVerity" value="0">


<tr><td>&nbsp;</td><td></td><td><br/><input class="formbutton" type="submit" value="Save Changes"/> 			
...
objForm.CColumns.validatePositiveInt();
objForm.PColumns.validatePositiveInt();
objForm.email_port.validatePositiveInt();
