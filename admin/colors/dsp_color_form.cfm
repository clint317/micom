...
<cfswitch expression="#colors#">
	...
	<cfcase value="add">
		<cfif isdefined("attributes.color_id")>
			...
			<cfloop list="#fieldlist#" index="counter">
				<cfset attributes[counter] = qry_get_color[counter][1]>
			</cfloop>
			<cfset act_title="Copy Palette">	
		<cfelse>
			<!--- Set the form fields to current color palette --->
			<cfloop list="#fieldlist#" index="counter">
				<cfset attributes[counter] = request.getcolors[counter][1]>
			</cfloop>
	...
	<cfcase value="edit">
		<cfloop list="#fieldlist#" index="counter">
			<!--- <cfdump var="#qry_get_color#"><cfabort> --->
			<cfset attributes[counter] = qry_get_color[counter][1]>
		</cfloop>
...
<script type="text/javascript">
	function colortool() {
		newWindow = openWin( 'colortool.cfm', 'colortool', 'width=800,height=750,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=1,resizable=1' ); 
	newWindow.focus();
	}	
</script>
...
<cfmodule template="../../customtags/putline.cfm" linetype="thin" linecolor="#Request.GetColors.InputHBgcolor#"/>
  ...
  <tr> 
    ...
    <td valign="middle" class="formtext" width="75" nowrap="nowrap"><font color="#attributes.MainText#">Text</font></td>
    <td width="75%">
  ...
  <tr> 
    <td valign="middle" class="formtext" nowrap="nowrap"><font color="#attributes.MainLink#">Links</font></td>
    <td valign="top">   
    <input type="text" name="MainLink" value="#attributes.MainLink#" size="7" maxlength="10" class="formfield" id="MainLink"/>
	#putswatch('MainLink')#
    </td>
    <td valign="middle" class="formtext" nowrap="nowrap"><font color="#attributes.MainVLink#">Visited Links</font></td>
    <td>
  ...
  <tr> 
    <td valign="middle" class="formtext" nowrap="nowrap">Line Color</td>
    <td valign="top">
	<input type="text" name="linecolor" value="#attributes.linecolor#" size="7" maxlength="10" class="formfield" id="linecolor"/>
	#putswatch('linecolor')#
    </td>
	 <td valign="middle" class="formtext" nowrap="nowrap"><nobr>Background Color</nobr></td>
    <td valign="top">
  ...
  <tr> 
  	<td valign="middle" class="formtext" nowrap="nowrap">Layout file</td>
  	<td  valign="top">
		<input type="text" name="layoutfile" size="30" maxlength="100" value="#attributes.layoutfile#" class="formfield"/>
	</td>
  
  	<td valign="middle" class="formtext" nowrap="nowrap">Parameters</td>
  	<td  valign="top"><input type="text" name="passparam" size="30" maxlength="100" value="#attributes.passparam#" class="formfield"/></td>
 
  </tr>
  
  <tr>
    <td valign="top" class="formtext" nowrap="nowrap"><nobr>Background Image</nobr></td>
    <td  valign="top"> 
        <input type="text" name="Bgimage" size="30" maxlength="100" value="#attributes.Bgimage#" class="formfield"/>
       <a href="JavaScript: newWindow = openWin('#self#?fuseaction=home.admin&select=image&fieldname=Bgimage&fieldvalue=#attributes.Bgimage#', 'images', 'width=850,height=700,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=0,resizable=1'); newWindow.focus();" class="formtextsmall">Image&nbsp;Manager</a><br/>
      </td>
    ...
    <tr> 
    <td valign="middle" class="formtext" nowrap="nowrap">Main Line
	
	</td>
    <td  valign="top">  
      <input type="text" name="mainlineimage" size="30" maxlength="100" value="#attributes.mainlineimage#" class="formfield"/> 
	 <br/><span class="formtextsmall">'HR' or
      <a href="JavaScript: newWindow = openWin('#self#?fuseaction=home.admin&select=image&fieldname=mainlineimage', 'images', 'width=850,height=700,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=0,resizable=1'); newWindow.focus();" class="formtextsmall">Image Manager</a><br/></span></td>

    <td valign="top" class="formtext"nowrap="nowrap">Minor Line</td>
    <td  valign="top">  
      <input type="text" name="minorlineimage" size="30" maxlength="100" value="#attributes.minorlineimage#" class="formfield"/>
		<br/><span class="formtextsmall">'HR' or
      <a href="JavaScript: newWindow = openWin('#self#?fuseaction=home.admin&select=image&fieldname=minorlineimage', 'images', 'width=850,height=700,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=0,resizable=1'); newWindow.focus();" class="formtextsmall">Image Manager</a><br/></span></td>
  </tr>
  <tr> 
    <td colspan="4"><cfmodule template="../../customtags/putline.cfm" linetype="thin"/></td>
      ...
      <tr> 
    <td valign="top" class="formtext" nowrap="nowrap">'New'&nbsp;Image</td>
    <td valign="top"> 
        <input type="text" name="Newimage" size="30" maxlength="100" value="#attributes.Newimage#" class="formfield"/><br/>
       <a href="JavaScript: newWindow = openWin('#self#?fuseaction=home.admin&select=image&fieldname=Newimage&fieldvalue=#attributes.Newimage#', 'images', 'width=850,height=700,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=0,resizable=1'); newWindow.focus();" class="formtextsmall">Image&nbsp;Manager</a><br/>
      </td>
    <td valign="top" class="formtext">'Sale'&nbsp;Image</td>
    <td  valign="top"> 
        <input type="text" name="Saleimage" size="30" maxlength="100" value="#attributes.saleimage#" class="formfield"/><br/>
       <a href="JavaScript: newWindow = openWin('#self#?fuseaction=home.admin&select=image&fieldname=Saleimage&fieldvalue=#attributes.Saleimage#', 'images', 'width=850,height=700,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=0,resizable=1'); newWindow.focus();" class="formtextsmall">Image&nbsp;Manager</a><br/>
      </td>
  </tr>
  
  <tr>
     <td valign="top" class="formtext"nowrap="nowrap"><nobr>'Hot' Image</nobr></td>
     <td  valign="top" colspan = 3> 
        <input type="text" name="hotImage" size="30" maxlength="100" value="#attributes.hotImage#" class="formfield"/><br/>
       <a href="JavaScript: newWindow = openWin('#self#?fuseaction=home.admin&select=image&fieldname=hotImage&fieldvalue=#attributes.hotImage#', 'images', 'width=850,height=700,toolbar=0,location=0,directories=0,status=1,menuBar=0,scrollBars=0,resizable=1'); newWindow.focus();" class="formtextsmall">Image&nbsp;Manager</a><br/>
  </tr>
