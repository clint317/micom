...
<!--- 	<cfoutput>
	<!--- Output back button --->
	<img src="#Request.ImagePath#icons/left.gif" border="0" valign="middle" alt="" hspace="2" vspace="0" /> 
...
<script language = "JavaScript">
	...
	<cfif len(nextitems) AND ListFirst(nextitems,"^") is "#attributes.type#">
		...
		<cfelse>
			...
			<cfoutput>
			<!-- start customtags/nextitems.cfm -->
			<div id="nextitems" class="customtags">
			<img src="#Request.ImagePath#icons/left.gif" border="0" style="vertical-align: middle" alt="" hspace="2" vspace="0" /> <a href="#XHTMLFormat(prevlink)#" <cfif len(attributes.class)>class="#attributes.class#"</cfif> onmouseover="dmim('back'); return document.returnValue;" onmouseout="dmim(''); return document.returnValue;">back</a>
			...
			<img src="#Request.ImagePath#icons/right.gif" border="0" style="vertical-align: middle" alt="" hspace="2" vspace="0" />
			</div>
			<!-- end customtags/nextitems.cfm -->
			</cfoutput>
